...
- [04. Modules](./04-modules.md) — extension layout and manifest example
- [05. API Design](./05-api-design.md) — `CoreContext` and IPC contracts
- [10. Security](./10-security.md) — isolation, chroot, permission prompts
- [16. Omni-Input System](./16-omni-input-system.md) — tool / provider / orchestrator roles
- [17. Frontend Extensions](./17-frontend-extensions.md) — UI loading and omni bar events
