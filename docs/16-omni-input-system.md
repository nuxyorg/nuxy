...
In a system where extensions control features, Nuxy must act as a strict traffic controller. If an AI Assistant wants to silently use the "Currency Converter" extension, it needs to know *exactly* what parameters the converter accepts, and whether the converter even *wants* to be called by an AI.
