...
| 2 | [Copyable icon grid](02-icon-grid-copyable.md) | `task/icon-grid-copyable` | — | in progress |
...
| 6 | [Linux DE install/config docs](06-linux-de-install-docs.md) | `task/linux-de-docs` | — | in progress |
