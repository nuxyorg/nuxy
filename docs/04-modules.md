...
- Nuxy's directory watcher detects the new folder, reads the manifest, spawns the backend worker, and mounts the React frontend instantly without restarting the application.
