...
export function register(core: CoreContext): void {
  ...
  core.ipc.handle(
    'docker:containers',
    async (payload: unknown): Promise<DockerContainer[]> => {
  ...
  core.ipc.handle(
    'docker:start',
    async (payload: unknown): Promise<ActionResult> => {
  ...
  core.ipc.handle(
    'docker:logs',
    async (payload: unknown): Promise<LogsResult> => {
