...
See also: [DOM Manipulation Rules](../website/docs/extensions/dom-manipulation.md) · enforced locally via `pnpm lint`.
...
| Imperative DOM rules      | [DOM Manipulation](../website/docs/extensions/dom-manipulation.md)     | Banned APIs, ESLint enforcement, allowlist                                          |
...
See §5.13 and [DOM Manipulation Rules](../website/docs/extensions/dom-manipulation.md).
