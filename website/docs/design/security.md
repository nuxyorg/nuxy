...
3. The Kernel sends a message to the shell UI: _"Extension A wants to read your clipboard."_
...
| ------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------ |
| Extension access and permissions      | [Extension Access](/extensions/extension-access) | Implemented vs planned permissions, clipboard consent status |
| Plugin system and isolation loading   | [Plugin System](/design/modular-plugin-system)   | Thread spawning and CoreContext proxy detail                 |
| Web Components isolation (Shadow DOM) | [Lit Renderer](/design/lit-renderer)             | Composition API, tool host, manifest slot claims             |
