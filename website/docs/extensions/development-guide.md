...
::: tip Start here
New to extension authoring? Begin with [Your First Extension](/extensions/first-extension), then read [Frontend Structure](/extensions/frontend-structure) and [Manifest Reference](/extensions/manifest). Use this guide as the complete ruleset and reference.
:::
...
See [Frontend Structure](/extensions/frontend-structure) for the full decision guide.
...
| ------------------------- | ---------------------------------------------------- | ----------------------------------------------------------------------------------- |
| CoreContext API reference | [Extension Access](/extensions/extension-access)     | Full list of implemented and planned host APIs, renderer bridge, and manifest rules |
| Security model            | [Security](/design/security)                         | Thread isolation, chroot jails, and permission prompt design                        |
