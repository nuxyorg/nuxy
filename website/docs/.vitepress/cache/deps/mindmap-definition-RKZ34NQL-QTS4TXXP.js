...
var parser = (function () {
  ...
  var parser2 = {
    ...
    table: [
      ...
      o($Vb, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: $V5, 22: $V6 }),
      o($Vb, [2, 18]),
      o($Vb, [2, 19]),
      o($Vb, [2, 20]),
      o($Vb, [2, 21]),
...
var MindmapDB =
  ((_a = class {
    ...
    addNode(level, id, descr, type) {
      ...
      let padding =
        ((_a2 = conf.mindmap) == null ? void 0 : _a2.padding) ??
...
var draw = __name(async (text, id, _version, diagObj) => {
  ...
  setupViewPortForSVG(
    svg,
    ((_a2 = data4Layout.config.mindmap) == null ? void 0 : _a2.padding) ??
      defaultConfig_default.mindmap.padding,
    'mindmapDiagram',
    ((_b = data4Layout.config.mindmap) == null ? void 0 : _b.useMaxWidth) ??
      defaultConfig_default.mindmap.useMaxWidth
  )
}, 'draw')
...
export { diagram }
//# sourceMappingURL=mindmap-definition-RKZ34NQL-QTS4TXXP.js.map
