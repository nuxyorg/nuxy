...
import { registerLayoutLoaders } from './chunk-EF52VPOW.js'
import './chunk-3XC6LI4J.js'
import './chunk-SLZZQQYS.js'
import './chunk-NCFOLWPN.js'
import './chunk-EOLJNIOX.js'
import './chunk-5G2FUE7H.js'
import './chunk-YGFUTLTO.js'
import { dedent, registerIconPacks } from './chunk-4WLP3MT7.js'
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import { __name, log, select_default, setLogLevel } from './chunk-X4LE64DB.js'
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import('./c4Diagram-AAUBKEIU-DC6SB3SW.js')
...
var detector2 = __name((txt, config) => {
  var _a2, _b
  if (
    ((_a2 = config == null ? void 0 : config.flowchart) == null ? void 0 : _a2.defaultRenderer) ===
      'dagre-wrapper' ||
    ((_b = config == null ? void 0 : config.flowchart) == null ? void 0 : _b.defaultRenderer) ===
      'elk'
  ) {
    return false
  }
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-I6XJVG4X-MXPCSQ3E.js')
...
var detector3 = __name((txt, config) => {
  ...
  if (
    /^\s*graph/.test(txt) &&
    ((_c = config == null ? void 0 : config.flowchart) == null ? void 0 : _c.defaultRenderer) ===
      'dagre-wrapper'
  ) {
    return true
  }
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import('./erDiagram-TEJ5UH35-3XP4G6PG.js')
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import('./gitGraphDiagram-PVQCEYII-2W5WGMMB.js')
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import('./ganttDiagram-6RSMTGT7-XIHXKIPZ.js')
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import('./infoDiagram-5YYISTIA-AXWPSTK5.js')
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import('./pieDiagram-4H26LBE5-336AIWNH.js')
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import('./quadrantDiagram-W4KKPZXB-SYYZY5OR.js')
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import('./xychartDiagram-2RQKCTM6-36I3S7QQ.js')
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import('./requirementDiagram-4Y6WPE33-7WTNJVN7.js')
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import('./sequenceDiagram-3UESZ5HK-52IOWDA2.js')
...
var detector13 = __name((txt, config) => {
  var _a2
  if (
    ((_a2 = config == null ? void 0 : config.class) == null ? void 0 : _a2.defaultRenderer) ===
    'dagre-wrapper'
  ) {
    return false
  }
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import('./classDiagram-4FO5ZUOK-7TTRTYLA.js')
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import('./classDiagram-v2-Q7XG4LA2-XSO23SLM.js')
...
var detector15 = __name((txt, config) => {
  var _a2
  if (
    ((_a2 = config == null ? void 0 : config.state) == null ? void 0 : _a2.defaultRenderer) ===
    'dagre-wrapper'
  ) {
    return false
  }
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-AJRCARHV-YRTDH65H.js')
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-v2-BHNVJYJU-BZ535WEM.js')
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import('./journeyDiagram-JHISSGLW-PK2D4HTH.js')
...
var detector18 = __name((txt, config = {}) => {
  ...
  if (
    ...
    (/^\s*(flowchart|graph)/.test(txt) &&
      ((_a2 = config == null ? void 0 : config.flowchart) == null
        ? void 0
        : _a2.defaultRenderer) === 'elk')
  ) {
    config.layout = 'elk'
    return true
  }
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import('./timeline-definition-PNZ67QCA-RRIIIWWJ.js')
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import('./mindmap-definition-RKZ34NQL-QTS4TXXP.js')
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import('./kanban-definition-UN3LZRKU-3J2WRWZE.js')
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import('./sankeyDiagram-5OEKKPKP-LPYPCPU7.js')
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-LMA3HP47-X5BFGHMD.js')
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-2AECGRRQ-OBFIZAHG.js')
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import('./blockDiagram-GPEHLZMM-HTHIPNFI.js')
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-5GNKFQAL-3XC46BY2.js')
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import('./architectureDiagram-3BPJPVTR-XZXY5MZN.js')
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-KO2AKTUF-QSZSQFM3.js')
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import('./ishikawaDiagram-YF4QCWOH-B57PALLU.js')
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import('./vennDiagram-CIIHVFJN-Z3TDJVSR.js')
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-OG6HWLK6-MFGRJDNL.js')
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import('./wardleyDiagram-YWT4CUSO-HD3XP7YQ.js')
...
var MAX_TEXTLENGTH_EXCEEDED_MSG =
      ...
      if (!isEmpty(styleClassDef.textStyles)) {
        cssStyles.insertRule(
          cssImportantStyles(
            styleClassDef.id,
            'tspan',
            ((styleClassDef == null ? void 0 : styleClassDef.textStyles) || []).map((s) =>
    ...
    middleware([
      __name(function addNamespace(element, _index, _children, _callback) {
        if (element.type === 'rule' && Array.isArray(element.props)) {
          ...
          const nestedAtRules = [MEDIA, SUPPORTS, LAYER, SCOPE, '@container', '@starting-style']
...
var putIntoIFrame = __name((svgCode = '', svgElement) => {
  ...
  const height = (
    (_b =
      (_a2 = svgElement == null ? void 0 : svgElement.viewBox) == null ? void 0 : _a2.baseVal) ==
    null
      ? void 0
      : _b.height
  )
...
var render = __name(async function (id33, text, svgContainingElement) {
  ...
  const diagramClassDefs =
    (_b = (_a2 = diag.renderer).getClasses) == null ? void 0 : _b.call(_a2, text, diag)
...
function initialize(userOptions = {}) {
  ...
  if (
    (options == null ? void 0 : options.fontFamily) &&
    !((_a2 = options.themeVariables) == null ? void 0 : _a2.fontFamily)
  ) {
...
var runThrowsErrors = __name(async function (
  ...
  const idGenerator = new utils_default.InitIDGenerator(
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    txt = dedent(utils_default.entityDecode(txt))
      .trim()
      .replace(/<br\s*\/?>/gi, '<br/>')
...
var registerExternalDiagrams = __name(async (diagrams, { lazyLoad = true } = {}) => {
  addDiagrams()
