import { populateCommonDb } from './chunk-3X7UDNOU.js'
...
import { createText, getIconSVG, registerIconPacks, unknownIcon } from './chunk-4WLP3MT7.js'
import { cleanAndMerge, getEdgeId } from './chunk-N5H3GFM2.js'
import {
  clear,
  ...
  setDiagramTitle,
  setupGraphViewbox,
} from './chunk-K7N6YW67.js'
import { __name, log, select_default } from './chunk-X4LE64DB.js'
import './chunk-R6XR7RJH.js'
import './chunk-WPKVCK7P.js'
import { cytoscape as cytoscape2 } from './chunk-U2ZJCB25.js'
import { __commonJS, __toESM } from './chunk-EQCVQC35.js'
        ...
        (function (modules) {
          ...
          function (module2, exports2, __webpack_require__) {
            ...
            LNode.prototype.getHalfTheDiagonal = function () {
              return (
                Math.sqrt(this.rect.height * this.rect.height + this.rect.width * this.rect.width) /
                2
              )
            }
            ...
            LNode.prototype.scatter = function () {
              ...
              randomCenterX =
                LayoutConstants.WORLD_CENTER_X + RandomSeed.nextDouble() * (maxX - minX) + minX
              var minY = -LayoutConstants.INITIAL_WORLD_BOUNDARY
              var maxY = LayoutConstants.INITIAL_WORLD_BOUNDARY
              randomCenterY =
                LayoutConstants.WORLD_CENTER_Y + RandomSeed.nextDouble() * (maxY - minY) + minY
          ...
          function (module2, exports2, __webpack_require__) {
            ...
            LGraphManager.prototype.remove = function (lObj) {
              if (lObj instanceof LGraph) {
                ...
                if (
                  !(edge.source.edges.indexOf(edge) != -1 && edge.target.edges.indexOf(edge) != -1)
                ) {
                  throw "Source and/or target doesn't know this edge!"
                }
          ...
          function (module2, exports2, __webpack_require__) {
            ...
            IGeometry.calcSeparationAmount = function (
              ...
              overlapAmount[0] =
                Math.min(rectA.getRight(), rectB.getRight()) - Math.max(rectA.x, rectB.x)
              overlapAmount[1] =
                Math.min(rectA.getBottom(), rectB.getBottom()) - Math.max(rectA.y, rectB.y)
          ...
          function (module2, exports2, __webpack_require__) {
              ...
              for (var i = 0; i < allEdges.length; i++) {
                ...
                if (edge.isInterGraph) {
                  ...
                  edge.idealLength +=
                    ...
                    (source.getInclusionTreeDepth() + target.getInclusionTreeDepth() - 2 * lcaDepth)
                }
              }
            }
              ...
              if (this.incremental) {
                if (s > FDLayoutConstants.ADAPTATION_LOWER_NODE_LIMIT) {
                  this.coolingFactor = Math.max(
                    this.coolingFactor * FDLayoutConstants.COOLING_ADAPTATION_FACTOR,
                    this.coolingFactor -
            ...
            FDLayout.prototype.calcRepulsionForces = function () {
              ...
              if (this.useFRGridVariant) {
                if (
                  this.totalIterations % FDLayoutConstants.GRID_CALCULATION_CHECK_PERIOD == 1 &&
                  gridUpdateAllowed
                ) {
                  this.updateGrid()
                }
            ...
            FDLayout.prototype.calcRepulsionForce = function (nodeA, nodeB) {
              ...
              if (rectA.intersects(rectB)) {
                ...
                repulsionForce =
                  ((nodeA.nodeRepulsion / 2 + nodeB.nodeRepulsion / 2) *
                    nodeA.noOfChildren *
                    nodeB.noOfChildren) /
                  distanceSquared
              ...
              if (node.getOwner() == this.graphManager.getRoot()) {
                ...
                if (absDistanceX > estimatedSize || absDistanceY > estimatedSize) {
                  node.gravitationForceX =
                    -this.gravityConstant * distanceX * this.compoundGravityConstant
                  node.gravitationForceY =
                    -this.gravityConstant * distanceY * this.compoundGravityConstant
                }
              }
            }
            ...
            FDLayout.prototype.calcGrid = function (graph) {
              ...
              var sizeY = 0
              sizeX = parseInt(
                Math.ceil((graph.getRight() - graph.getLeft()) / this.repulsionRange)
              )
              sizeY = parseInt(
                Math.ceil((graph.getBottom() - graph.getTop()) / this.repulsionRange)
              )
            ...
            FDLayout.prototype.addNodeToGrid = function (v, left, top) {
              ...
              finishX = parseInt(
                Math.floor((v.getRect().width + v.getRect().x - left) / this.repulsionRange)
              )
              startY = parseInt(Math.floor((v.getRect().y - top) / this.repulsionRange))
              finishY = parseInt(
                Math.floor((v.getRect().height + v.getRect().y - top) / this.repulsionRange)
              )
            ...
            SVD.svd = function (A) {
              ...
              while (p > 0) {
                ...
                for (_k3 = p - 2; _k3 >= -1; _k3--) {
                  ...
                  if (
                    Math.abs(e[_k3]) <=
                    tiny + eps * (Math.abs(this.s[_k3]) + Math.abs(this.s[_k3 + 1]))
                  ) {
                    e[_k3] = 0
                    break
                  }
                ...
                if (_k3 === p - 2) {
                  ...
                  for (ks = p - 1; ks >= _k3; ks--) {
                    ...
                    var _t4 =
                      (ks !== p ? Math.abs(e[ks]) : 0) + (ks !== _k3 + 1 ? Math.abs(e[ks - 1]) : 0)
                      ...
                      for (var _j7 = _k3; _j7 < p; _j7++) {
                        ...
                        if (wantu) {
                          for (var _i21 = 0; _i21 < this.m; _i21++) {
                            ...
                            this.U[_i21][_k3 - 1] =
                              -_sn * this.U[_i21][_j7] + _cs * this.U[_i21][_k3 - 1]
                            this.U[_i21][_j7] = _t6
                          }
                        }
                      }
                      ...
                      for (var _j8 = _k3; _j8 < p - 1; _j8++) {
                        ...
                        if (wantv) {
                          for (var _i22 = 0; _i22 < this.n; _i22++) {
                            ...
                            this.V[_i22][_j8 + 1] =
                              -_sn2 * this.V[_i22][_j8] + _cs2 * this.V[_i22][_j8 + 1]
                            this.V[_i22][_j8] = _t7
                          }
                        }
                        _t7 = SVD.hypot(_f2, g)
                        ...
                        if (wantu && _j8 < this.m - 1) {
                          for (var _i23 = 0; _i23 < this.m; _i23++) {
                            ...
                            this.U[_i23][_j8 + 1] =
                              -_sn2 * this.U[_i23][_j8] + _cs2 * this.U[_i23][_j8 + 1]
                            this.U[_i23][_j8] = _t7
                          }
                        }
                      }
              ...
              (module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                CoSELayout.prototype.initSpringEmbedder = function () {
                  ...
                  this.maxCoolingCycle =
                    this.maxIterations / FDLayoutConstants.CONVERGENCE_CHECK_PERIOD
                    ...
                    if (this.growTreeIterations % 10 == 0) {
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        if (CoSEConstants.PURE_INCREMENTAL)
                          this.coolingFactor =
                            FDLayoutConstants.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2
                        else
                          this.coolingFactor = FDLayoutConstants.DEFAULT_COOLING_FACTOR_INCREMENTAL
                      } else {
                        this.isTreeGrowing = false
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (CoSEConstants.RELAX_MOVEMENT_ON_CONSTRAINTS) {
                      ...
                      this.constraints.relativePlacementConstraint.forEach(function (constraint) {
                        if (constraint.left) {
                          var nodeIdLeft = nodeToDummyForVerticalAlignment.has(constraint.left)
                            ? nodeToDummyForVerticalAlignment.get(constraint.left)
                            : constraint.left
                          var nodeIdRight = nodeToDummyForVerticalAlignment.has(constraint.right)
                            ? nodeToDummyForVerticalAlignment.get(constraint.right)
                            : constraint.right
                          if (!self.nodesInRelativeHorizontal.includes(nodeIdLeft)) {
                            self.nodesInRelativeHorizontal.push(nodeIdLeft)
                            self.nodeToRelativeConstraintMapHorizontal.set(nodeIdLeft, [])
                            if (self.dummyToNodeForVerticalAlignment.has(nodeIdLeft)) {
                              self.nodeToTempPositionMapHorizontal.set(
                                nodeIdLeft,
                                self.idToNodeMap
                                  .get(self.dummyToNodeForVerticalAlignment.get(nodeIdLeft)[0])
                                  .getCenterX()
                              )
                            } else {
                              self.nodeToTempPositionMapHorizontal.set(
                                nodeIdLeft,
                                self.idToNodeMap.get(nodeIdLeft).getCenterX()
                              )
                            }
                          }
                          if (!self.nodesInRelativeHorizontal.includes(nodeIdRight)) {
                            ...
                            if (self.dummyToNodeForVerticalAlignment.has(nodeIdRight)) {
                              self.nodeToTempPositionMapHorizontal.set(
                                nodeIdRight,
                                self.idToNodeMap
                                  .get(self.dummyToNodeForVerticalAlignment.get(nodeIdRight)[0])
                                  .getCenterX()
                              )
                            } else {
                              self.nodeToTempPositionMapHorizontal.set(
                                nodeIdRight,
                                self.idToNodeMap.get(nodeIdRight).getCenterX()
                              )
                            }
                          }
                          self.nodeToRelativeConstraintMapHorizontal
                            .get(nodeIdLeft)
                            .push({ right: nodeIdRight, gap: constraint.gap })
                          self.nodeToRelativeConstraintMapHorizontal
                            .get(nodeIdRight)
                            .push({ left: nodeIdLeft, gap: constraint.gap })
                        } else {
                          var nodeIdTop = nodeToDummyForHorizontalAlignment.has(constraint.top)
                            ? nodeToDummyForHorizontalAlignment.get(constraint.top)
                            : constraint.top
                          var nodeIdBottom = nodeToDummyForHorizontalAlignment.has(
                            constraint.bottom
                          )
                            ? nodeToDummyForHorizontalAlignment.get(constraint.bottom)
                            : constraint.bottom
                          if (!self.nodesInRelativeVertical.includes(nodeIdTop)) {
                            self.nodesInRelativeVertical.push(nodeIdTop)
                            self.nodeToRelativeConstraintMapVertical.set(nodeIdTop, [])
                            if (self.dummyToNodeForHorizontalAlignment.has(nodeIdTop)) {
                              self.nodeToTempPositionMapVertical.set(
                                nodeIdTop,
                                self.idToNodeMap
                                  .get(self.dummyToNodeForHorizontalAlignment.get(nodeIdTop)[0])
                                  .getCenterY()
                              )
                            } else {
                              self.nodeToTempPositionMapVertical.set(
                                nodeIdTop,
                                self.idToNodeMap.get(nodeIdTop).getCenterY()
                              )
                            }
                          }
                          if (!self.nodesInRelativeVertical.includes(nodeIdBottom)) {
                            ...
                            if (self.dummyToNodeForHorizontalAlignment.has(nodeIdBottom)) {
                              self.nodeToTempPositionMapVertical.set(
                                nodeIdBottom,
                                self.idToNodeMap
                                  .get(self.dummyToNodeForHorizontalAlignment.get(nodeIdBottom)[0])
                                  .getCenterY()
                              )
                            } else {
                              self.nodeToTempPositionMapVertical.set(
                                nodeIdBottom,
                                self.idToNodeMap.get(nodeIdBottom).getCenterY()
                              )
                            }
                          }
                          self.nodeToRelativeConstraintMapVertical
                            .get(nodeIdTop)
                            .push({ bottom: nodeIdBottom, gap: constraint.gap })
                          self.nodeToRelativeConstraintMapVertical
                            .get(nodeIdBottom)
                            .push({ top: nodeIdTop, gap: constraint.gap })
                        }
                      })
                    } else {
                      ...
                      this.constraints.relativePlacementConstraint.forEach(function (constraint) {
                        if (constraint.left) {
                          var left = nodeToDummyForVerticalAlignment.has(constraint.left)
                            ? nodeToDummyForVerticalAlignment.get(constraint.left)
                            : constraint.left
                          var right = nodeToDummyForVerticalAlignment.has(constraint.right)
                            ? nodeToDummyForVerticalAlignment.get(constraint.right)
                            : constraint.right
                          ...
                          var top = nodeToDummyForHorizontalAlignment.has(constraint.top)
                            ? nodeToDummyForHorizontalAlignment.get(constraint.top)
                            : constraint.top
                          var bottom = nodeToDummyForHorizontalAlignment.has(constraint.bottom)
                            ? nodeToDummyForHorizontalAlignment.get(constraint.bottom)
                            : constraint.bottom
                      ...
                      var resultOnHorizontal = constructComponents(
                        subGraphOnHorizontal,
                        self.fixedNodesOnHorizontal
                      )
                      this.componentsOnHorizontal = resultOnHorizontal.components
                      this.fixedComponentsOnHorizontal = resultOnHorizontal.isFixed
                      var resultOnVertical = constructComponents(
                        subGraphOnVertical,
                        self.fixedNodesOnVertical
                      )
                    ...
                    if (this.constraints.alignmentConstraint.vertical) {
                      ...
                      for (var i = 0; i < allVerticalAlignments.length; i++) {
                        ...
                        for (var j = 0; j < allVerticalAlignments[i].length; j++) {
                          ...
                          totalDisplacementX += this.idToNodeMap.get(
                            allVerticalAlignments[i][j]
                          ).displacementX
                        }
                        var averageDisplacementX =
                          totalDisplacementX / allVerticalAlignments[i].length
                        for (var j = 0; j < allVerticalAlignments[i].length; j++) {
                          this.idToNodeMap.get(allVerticalAlignments[i][j]).displacementX =
                            averageDisplacementX
                        }
                      }
                    }
                    if (this.constraints.alignmentConstraint.horizontal) {
                      ...
                      for (var i = 0; i < allHorizontalAlignments.length; i++) {
                        ...
                        for (var j = 0; j < allHorizontalAlignments[i].length; j++) {
                          ...
                          totalDisplacementY += this.idToNodeMap.get(
                            allHorizontalAlignments[i][j]
                          ).displacementY
                        }
                        var averageDisplacementY =
                          totalDisplacementY / allHorizontalAlignments[i].length
                        for (var j = 0; j < allHorizontalAlignments[i].length; j++) {
                          this.idToNodeMap.get(allHorizontalAlignments[i][j]).displacementY =
                            averageDisplacementY
                        }
                      }
                    }
                  }
                    ...
                    if (CoSEConstants.RELAX_MOVEMENT_ON_CONSTRAINTS) {
                      ...
                      this.nodesInRelativeHorizontal.forEach(function (nodeId) {
                        if (!self.fixedNodesOnHorizontal.has(nodeId)) {
                          ...
                          if (self.dummyToNodeForVerticalAlignment.has(nodeId)) {
                            displacement = self.idToNodeMap.get(
                              self.dummyToNodeForVerticalAlignment.get(nodeId)[0]
                            ).displacementX
                          } else {
                          ...
                          self.nodeToRelativeConstraintMapHorizontal
                            ...
                            .forEach(function (constraint) {
                              if (constraint.right) {
                                var diff =
                                  self.nodeToTempPositionMapHorizontal.get(constraint.right) -
                                  self.nodeToTempPositionMapHorizontal.get(nodeId) -
                                  displacement
                                ...
                                var diff =
                                  self.nodeToTempPositionMapHorizontal.get(nodeId) -
                                  self.nodeToTempPositionMapHorizontal.get(constraint.left) +
                                  displacement
                                if (diff < constraint.gap) {
                                  displacement += constraint.gap - diff
                                }
                          ...
                          self.nodeToTempPositionMapHorizontal.set(
                            nodeId,
                            self.nodeToTempPositionMapHorizontal.get(nodeId) + displacement
                          )
                          if (self.dummyToNodeForVerticalAlignment.has(nodeId)) {
                            self.dummyToNodeForVerticalAlignment
                              .get(nodeId)
                              .forEach(function (nodeId2) {
                      ...
                      this.nodesInRelativeVertical.forEach(function (nodeId) {
                        if (!self.fixedNodesOnHorizontal.has(nodeId)) {
                          ...
                          if (self.dummyToNodeForHorizontalAlignment.has(nodeId)) {
                            displacement = self.idToNodeMap.get(
                              self.dummyToNodeForHorizontalAlignment.get(nodeId)[0]
                            ).displacementY
                          } else {
                          ...
                          self.nodeToRelativeConstraintMapVertical
                            ...
                            .forEach(function (constraint) {
                              if (constraint.bottom) {
                                var diff =
                                  self.nodeToTempPositionMapVertical.get(constraint.bottom) -
                                  self.nodeToTempPositionMapVertical.get(nodeId) -
                                  displacement
                                if (diff < constraint.gap) {
                                  displacement -= constraint.gap - diff
                                }
                                ...
                                var diff =
                                  self.nodeToTempPositionMapVertical.get(nodeId) -
                                  self.nodeToTempPositionMapVertical.get(constraint.top) +
                                  displacement
                                if (diff < constraint.gap) {
                                  displacement += constraint.gap - diff
                                }
                          ...
                          self.nodeToTempPositionMapVertical.set(
                            nodeId,
                            self.nodeToTempPositionMapVertical.get(nodeId) + displacement
                          )
                          if (self.dummyToNodeForHorizontalAlignment.has(nodeId)) {
                            self.dummyToNodeForHorizontalAlignment
                              .get(nodeId)
                              .forEach(function (nodeId2) {
                      ...
                      for (var i = 0; i < this.componentsOnHorizontal.length; i++) {
                        ...
                        if (this.fixedComponentsOnHorizontal[i]) {
                          ...
                          for (var j = 0; j < component.length; j++) {
                            if (this.dummyToNodeForVerticalAlignment.has(component[j])) {
                              var actualNodes = this.dummyToNodeForVerticalAlignment.get(
                                component[j]
                              )
                              sum +=
                                actualNodes.length *
                                this.idToNodeMap.get(actualNodes[0]).displacementX
                      ...
                      for (var i = 0; i < this.componentsOnVertical.length; i++) {
                        ...
                        if (this.fixedComponentsOnVertical[i]) {
                          ...
                          for (var j = 0; j < component.length; j++) {
                            if (this.dummyToNodeForHorizontalAlignment.has(component[j])) {
                              var actualNodes = this.dummyToNodeForHorizontalAlignment.get(
                                component[j]
                              )
                              sum +=
                                actualNodes.length *
                                this.idToNodeMap.get(actualNodes[0]).displacementY
                              count += actualNodes.length
                            } else {
                ...
                CoSELayout.prototype.clearZeroDegreeMembers = function () {
                  ...
                  Object.keys(this.memberGroups).forEach(function (id) {
                    ...
                    compoundNode.setCenter(
                      tiledZeroDegreePack[id].centerX,
                      tiledZeroDegreePack[id].centerY
                    )
                    ...
                    if (CoSEConstants.NODE_DIMENSIONS_INCLUDE_LABELS) {
                      ...
                      if (compoundNode.labelWidth) {
                        if (compoundNode.labelPosHorizontal == 'left') {
                          ...
                          compoundNode.labelPosHorizontal == 'center' &&
                          compoundNode.labelWidth > width
                        ) {
                      ...
                      if (compoundNode.labelHeight) {
                        if (compoundNode.labelPosVertical == 'top') {
                          ...
                          compoundNode.labelPosVertical == 'center' &&
                          compoundNode.labelHeight > height
                        ) {
                ...
                CoSELayout.prototype.tileCompoundMembers = function (childGraphMap, idToNode) {
                  ...
                  Object.keys(childGraphMap).forEach(function (id) {
                    ...
                    compoundNode.setCenter(
                      self.tiledMemberPack[id].centerX,
                      self.tiledMemberPack[id].centerY
                    )
                    compoundNode.labelMarginLeft = 0
                    compoundNode.labelMarginTop = 0
                    if (CoSEConstants.NODE_DIMENSIONS_INCLUDE_LABELS) {
                ...
                CoSELayout.prototype.calcIdealRowWidth = function (members, favorHorizontalDim) {
                  ...
                  var delta =
                    ...
                    4 *
                      (averageWidth + horizontalPadding) *
                      (averageHeight + verticalPadding) *
                      membersSize
                  var horizontalCountDouble =
                    (horizontalPadding - verticalPadding + Math.sqrt(delta)) /
                  ...
                  var idealWidth =
                    horizontalCount * (averageWidth + horizontalPadding) - horizontalPadding
                ...
                CoSELayout.prototype.tileNodesByFavoringDim = function (
                  nodes,
                  minWidth,
                  favorHorizontalDim
                ) {
                  ...
                  for (var i = 0; i < nodes.length; i++) {
                    ...
                    if (organization.rows.length == 0) {
                      ...
                      this.canAddHorizontal(organization, lNode.rect.width, lNode.rect.height)
                    ) {
                ...
                CoSELayout.prototype.canAddHorizontal = function (
                  ...
                  if (organization.idealRowWidth) {
                    ...
                    return (
                      lastRowWidth + extraWidth + organization.horizontalPadding <=
                      organization.idealRowWidth
                    )
                  }
                  ...
                  if (organization.rowHeight[sri] < extraHeight) {
                    if (sri > 0)
                      hDiff =
                        extraHeight + organization.verticalPadding - organization.rowHeight[sri]
                  }
                ...
                CoSELayout.prototype.shiftToLastRow = function (organization) {
                  ...
                  if (organization.width - organization.rowWidth[last] > diff && longest != last) {
                    ...
                    organization.width =
                      organization.rowWidth[instance.getLongestRowIndex(organization)]
                    ...
                    for (var i = 0; i < allNodes.length; i++) {
                      ...
                      if (
                        ...
                        if (CoSEConstants.PURE_INCREMENTAL) {
                          ...
                          var relativePosition = new DimensionD2(
                            node.getCenterX() - otherEnd.getCenterX(),
                            node.getCenterY() - otherEnd.getCenterY()
                          )
                ...
                CoSELayout.prototype.findPlaceforPrunedNode = function (nodeData2) {
                  ...
                  if (CoSEConstants.PURE_INCREMENTAL) {
                    prunedNode.setCenter(
                      nodeToConnect.getCenterX() + nodeData2[3].getWidth(),
                      nodeToConnect.getCenterY() + nodeData2[3].getHeight()
                    )
                  } else {
                    ...
                    if (startGridY > 0) {
                      for (var i = startGridX; i <= finishGridX; i++) {
                        controlRegions[0] +=
                          this.grid[i][startGridY - 1].length + this.grid[i][startGridY].length - 1
                      }
                    }
                    ...
                    if (startGridX > 0) {
                      for (var i = startGridY; i <= finishGridY; i++) {
                        controlRegions[3] +=
                          this.grid[startGridX - 1][i].length + this.grid[startGridX][i].length - 1
                      }
                    }
            ...
            902:
              ...
              (module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                ConstraintHandler.handleConstraints = function (layout) {
                      ...
                      if (!constraint.gap && constraint.gap != 0) {
                        if (constraint.left) {
                          constraint.gap =
                            ...
                            idToNodeMap.get(constraint.left).getWidth() / 2 +
                            idToNodeMap.get(constraint.right).getWidth() / 2
                        } else {
                          constraint.gap =
                            CoSEConstants.DEFAULT_EDGE_LENGTH +
                            idToNodeMap.get(constraint.top).getHeight() / 2 +
                            idToNodeMap.get(constraint.bottom).getHeight() / 2
                        }
                      }
                    })
                  }
                  ...
                  var findAppropriatePositionForRelativePlacement =
                    function findAppropriatePositionForRelativePlacement2(
                      graph,
                      direction,
                      fixedNodes2,
                      dummyPositions,
                      ...
                      function setUnion(setA, setB) {
                        ...
                        try {
                          for (
                            var _iterator = setB[Symbol.iterator](), _step;
                          ...
                          if (!fixedNodes2) {
                            if (direction == 'horizontal') {
                              positionMap.set(
                                key,
                                nodeIndexes.has(key)
                                  ? xCoords[nodeIndexes.get(key)]
                                  : dummyPositions.get(key)
                              )
                            } else {
                              positionMap.set(
                                key,
                                nodeIndexes.has(key)
                                  ? yCoords[nodeIndexes.get(key)]
                                  : dummyPositions.get(key)
                              )
                            }
                          }
                          ...
                          if (fixedIds.length > 0) {
                            ...
                            fixedIds.forEach(function (fixedId) {
                              if (direction == 'horizontal') {
                                positionMap.set(
                                  fixedId,
                                  nodeIndexes.has(fixedId)
                                    ? xCoords[nodeIndexes.get(fixedId)]
                                    : dummyPositions.get(fixedId)
                                )
                                ...
                                positionMap.set(
                                  fixedId,
                                  nodeIndexes.has(fixedId)
                                    ? yCoords[nodeIndexes.get(fixedId)]
                                    : dummyPositions.get(fixedId)
                                )
                                position += positionMap.get(fixedId)
                              }
                            ...
                            component.forEach(function (nodeId) {
                              if (direction == 'horizontal') {
                                _position += nodeIndexes.has(nodeId)
                                  ? xCoords[nodeIndexes.get(nodeId)]
                                  : dummyPositions.get(nodeId)
                              } else {
                                _position += nodeIndexes.has(nodeId)
                      ...
                      var _loop = function _loop2() {
                        ...
                        neighbors.forEach(function (neighbor) {
                          if (
                            positionMap.get(neighbor.id) <
                            positionMap.get(currentNode) + neighbor.gap
                          ) {
                            if (fixedNodes2 && fixedNodes2.has(neighbor.id)) {
                              var fixedPosition = void 0
                              if (direction == 'horizontal') {
                                fixedPosition = nodeIndexes.has(neighbor.id)
                                  ? xCoords[nodeIndexes.get(neighbor.id)]
                                  : dummyPositions.get(neighbor.id)
                              } else {
                                fixedPosition = nodeIndexes.has(neighbor.id)
                                  ? yCoords[nodeIndexes.get(neighbor.id)]
                                  : dummyPositions.get(neighbor.id)
                              }
                              positionMap.set(neighbor.id, fixedPosition)
                              if (fixedPosition < positionMap.get(currentNode) + neighbor.gap) {
                                var diff =
                                  positionMap.get(currentNode) + neighbor.gap - fixedPosition
                          ...
                          if (fixedNodes2) {
                            pastMap.set(
                              neighbor.id,
                              setUnion(pastMap.get(currentNode), pastMap.get(neighbor.id))
                            )
                          }
                        })
                      }
                      ...
                      if (fixedNodes2) {
                        ...
                        _components.forEach(function (component, index2) {
                          ...
                          try {
                            for (
                              var _iterator3 = component[Symbol.iterator](), _step3;
                              ...
                              if (direction == 'horizontal') {
                                posBefore = nodeIndexes.has(nodeId)
                                  ? xCoords[nodeIndexes.get(nodeId)]
                                  : dummyPositions.get(nodeId)
                              } else {
                                posBefore = nodeIndexes.has(nodeId)
                          ...
                          try {
                            for (
                              var _iterator4 = component[Symbol.iterator](), _step4;
                  ...
                  var applyReflectionForRelativePlacement =
                    function applyReflectionForRelativePlacement2(relativePlacementConstraints) {
                      var reflectOnY = 0,
                        notReflectOnY = 0
                      var reflectOnX = 0,
                        notReflectOnX = 0
                      relativePlacementConstraints.forEach(function (constraint) {
                        if (constraint.left) {
                          xCoords[nodeIndexes.get(constraint.left)] -
                            xCoords[nodeIndexes.get(constraint.right)] >=
                          0
                            ? reflectOnY++
                            : notReflectOnY++
                        } else {
                          yCoords[nodeIndexes.get(constraint.top)] -
                            yCoords[nodeIndexes.get(constraint.bottom)] >=
                          0
                            ? reflectOnX++
                            : notReflectOnX++
                        }
                  ...
                  var dagToUndirected = function dagToUndirected2(dag2) {
                    ...
                    dag2.forEach(function (value, key) {
                      value.forEach(function (adjacent) {
                        ...
                        undirected
                          .get(adjacent.id)
                          .push({ id: key, gap: adjacent.gap, direction: adjacent.direction })
                      })
                    })
                    return undirected
                  }
                      ...
                      if (constraint.left) {
                        if (dag.has(constraint.left)) {
                          ...
                          dag.set(constraint.left, [
                            { id: constraint.right, gap: constraint.gap, direction: 'horizontal' },
                          ])
                        }
                        ...
                        if (dag.has(constraint.top)) {
                          ...
                          dag.set(constraint.top, [
                            { id: constraint.bottom, gap: constraint.gap, direction: 'vertical' },
                          ])
                        }
                  ...
                  if (CoSEConstants.TRANSFORM_ON_CONSTRAINT_HANDLING) {
                    if (
                      constraints.fixedNodeConstraint &&
                      constraints.fixedNodeConstraint.length > 1
                    ) {
                        ...
                        if (constraints.alignmentConstraint.vertical) {
                          ...
                          var _loop2 = function _loop22(_i42) {
                            ...
                            var intersection = new Set(
                              [].concat(_toConsumableArray(alignmentSet)).filter(function (x) {
                      ...
                      if (largestComponentSize < dagUndirected.size / 2) {
                        ...
                        reflectionType = false
                        var positionMapHorizontal = findAppropriatePositionForRelativePlacement(
                          subGraphOnHorizontal,
                          'horizontal'
                        )
                        var positionMapVertical = findAppropriatePositionForRelativePlacement(
                          subGraphOnVertical,
                          'vertical'
                        )
                    ...
                    if (standardTransformation) {
                      ...
                      var tempMatrix = Matrix.multMat(
                        targetMatrixTranspose,
                        Matrix.transpose(sourceMatrixTranspose)
                      )
                      var SVDResult = SVD.svd(tempMatrix)
                      transformationMatrix = Matrix.multMat(
                        SVDResult.V,
                        Matrix.transpose(SVDResult.U)
                      )
                  ...
                  if (CoSEConstants.ENFORCE_CONSTRAINTS) {
                    if (
                      constraints.fixedNodeConstraint &&
                      constraints.fixedNodeConstraint.length > 0
                    ) {
                      ...
                      ;(function () {
                        ...
                        if (constraints.alignmentConstraint) {
                          if (constraints.alignmentConstraint.vertical) {
                            ...
                            var _loop6 = function _loop62(_i112) {
                              ...
                              dummyPositionsForVerticalAlignment.set(
                                'dummy' + _i112,
                                xCoords[nodeIndexes.get(verticalAlignment[_i112][0])]
                              )
                            }
                          ...
                          if (constraints.alignmentConstraint.horizontal) {
                            ...
                            var _loop7 = function _loop72(_i122) {
                              ...
                              dummyPositionsForHorizontalAlignment.set(
                                'dummy' + _i122,
                                yCoords[nodeIndexes.get(horizontalAlignment[_i122][0])]
                              )
                            }
                        ...
                        var _loop8 = function _loop82(nodeId2) {
                          dag.get(nodeId2).forEach(function (adjacent) {
                            ...
                            if (adjacent['direction'] == 'horizontal') {
                              sourceId = nodeToDummyForVerticalAlignment.get(nodeId2)
                                ? nodeToDummyForVerticalAlignment.get(nodeId2)
                                : nodeId2
                              ...
                              sourceId = nodeToDummyForHorizontalAlignment.get(nodeId2)
                                ? nodeToDummyForHorizontalAlignment.get(nodeId2)
                                : nodeId2
                        ...
                        try {
                          for (
                            var _iterator5 = dag.keys()[Symbol.iterator](), _step5;
                        ...
                        var positionMapHorizontal2 = findAppropriatePositionForRelativePlacement(
                          dagOnHorizontal,
                          'horizontal',
                          fixedNodesOnHorizontal,
                          dummyPositionsForVerticalAlignment,
                          componentSourcesOnHorizontal
                        )
                        var positionMapVertical2 = findAppropriatePositionForRelativePlacement(
                          dagOnVertical,
                          'vertical',
                          fixedNodesOnVertical,
                          dummyPositionsForHorizontalAlignment,
                          componentSourcesOnVertical
                        )
                        ...
                        try {
                          for (
                            var _iterator6 = positionMapHorizontal2.keys()[Symbol.iterator](),
                              _step6;
                        ...
                        try {
                          for (
                            var _iterator7 = positionMapVertical2.keys()[Symbol.iterator](), _step7;
                  ...
                  for (var _i13 = 0; _i13 < allNodes.length; _i13++) {
                    ...
                    if (_node.getChild() == null) {
                      _node.setCenter(
                        xCoords[nodeIndexes.get(_node.id)],
                        yCoords[nodeIndexes.get(_node.id)]
                      )
                    }
                  }
                }
          ...
          var __webpack_modules__ = {
                ...
                auxiliary.relocateComponent = function (originalCenter, componentResult, options) {
                  if (!options.fixedNodeConstraint) {
                    ...
                    if (options.quality == 'draft') {
                      ...
                      try {
                        for (
                          var _iterator = componentResult.nodeIndexes[Symbol.iterator](), _step;
                          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                          _iteratorNormalCompletion = true
                        ) {
            ...
            816:
              ...
              (module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                var coseLayout = function coseLayout2(options, spectralResult) {
                  ...
                  var processChildrenList = function processChildrenList2(
                    parent,
                    children,
                    layout,
                    options2
                          ...
                          if (!theChild.isParent()) {
                            theNode = parent.add(
                              new CoSENode(
                                ...
                                new DimensionD2(parseFloat(dimensions.w), parseFloat(dimensions.h))
                              )
                            )
                          } else {
                            ...
                            if (theChild.intersection(parentsWithoutChildren).length == 0) {
                              theNode = parent.add(
                                new CoSENode(
                                  ...
                                  new DimensionD2(parentInfo.width, parentInfo.height)
                                )
                              )
                            } else {
                              theNode = parent.add(
                  ...
                  var processEdges = function processEdges2(layout, gm2, edges2) {
                    ...
                    if (options.idealEdgeLength != null) {
                      if (edgeCount > 0)
                        CoSEConstants.DEFAULT_EDGE_LENGTH = FDLayoutConstants.DEFAULT_EDGE_LENGTH =
                  ...
                  var processConstraints = function processConstraints2(layout, options2) {
                    ...
                    if (options2.relativePlacementConstraint) {
                      layout.constraints['relativePlacementConstraint'] =
                        options2.relativePlacementConstraint
                    }
                  }
                  ...
                  if (options.gravityCompound != null)
                    CoSEConstants.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                      FDLayoutConstants.DEFAULT_COMPOUND_GRAVITY_STRENGTH = options.gravityCompound
            ...
            212:
              ...
              (module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                var aux = __webpack_require__2(548)
                var _require = __webpack_require__2(657),
                  spectralLayout = _require.spectralLayout
                var _require2 = __webpack_require__2(816),
                          ...
                          if (!packingEnabled) {
                            ...
                            if (options.quality == 'default' || options.quality == 'proof') {
                              ...
                              components.forEach(function (component, index) {
                                ...
                                aux.relocateComponent(
                                  componentCenters[index],
                                  coseResult[index],
                                  options
                                )
                              })
                                  ...
                                  component.edges().forEach(function (edge) {
                                    ...
                                    if (
                                      ...
                                      if (options.quality == 'draft') {
                                        ...
                                        if (
                                          coseResult[index][source.id()] &&
                                          coseResult[index][target.id()]
                                        ) {
                                          subgraph.edges.push({
                                ...
                                componentsEvaluated.forEach(function (index) {
                                  Object.keys(coseResult[index]).forEach(function (item) {
                                    ...
                                    nodeRectangle.setCenter(
                                      nodeRectangle.getCenterX() + shiftResult[_count].dx,
                                      nodeRectangle.getCenterY() + shiftResult[_count].dy
                                    )
                                  })
                                  _count++
                                })
...
function layoutArchitecture(
  ...
  return new Promise((resolve) => {
    const renderEl = select_default('body')
      .append('div')
      .attr('id', 'cy')
...
export { diagram }
//# sourceMappingURL=architectureDiagram-3BPJPVTR-XZXY5MZN.js.map
