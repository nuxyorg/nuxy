    ...
    !(function (t3, s) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(s)
          : ((t3 =
              'undefined' != typeof globalThis ? globalThis : t3 || self).dayjs_plugin_duration =
              s())
    })(exports, function () {
      'use strict'
      var t3,
        ...
        a = /\[([^\]]+)]|YYYY|YY|Y|M{1,2}|D{1,2}|H{1,2}|m{1,2}|s{1,2}|SSS/g,
        h = {
          years: o,
          months: u3,
          days: r,
        ...
        v = function (t4, s2) {
          return t4
            ? l(t4)
              ? { negative: true, format: '' + y(t4) + s2 }
              : { negative: false, format: '' + t4 + s2 }
        ...
        g = (function () {
          function l2(t4, s2, n2) {
            ...
            if (
              ((this.$d = {}),
              (this.$l = n2),
              void 0 === t4 && ((this.$ms = 0), this.parseFromMilliseconds()),
              s2)
            )
              return f(t4 * h[m(s2)], this)
          ...
          return (
            ...
            (y2.parseFromMilliseconds = function () {
              ...
              ;((this.$d.years = $(t4 / o)),
                ...
                (this.$d.seconds = $(t4 / n)),
                (t4 %= n),
                (this.$d.milliseconds = t4))
            }),
            (y2.toISOString = function () {
              var t4 = v(this.$d.years, 'Y'),
              ...
              var u4 = v(o2, 'S'),
                d2 =
                  ...
                  r2.negative ||
                  u4.negative,
                a2 = e2.format || r2.format || u4.format ? 'T' : '',
                h2 =
                  (d2 ? '-' : '') +
                  'P' +
                  t4.format +
            ...
            (y2.add = function (t4, s2, n2) {
              var i2
              return (
                (i2 = s2 ? t4 * h[m(s2)] : c(t4) ? t4.$ms : f(t4, this).$ms),
...
// ../node_modules/.pnpm/dayjs@1.11.21/node_modules/dayjs/esm/plugin/localizedFormat/utils.js
...
// ../node_modules/.pnpm/dayjs@1.11.21/node_modules/dayjs/esm/plugin/customParseFormat/index.js
...
var draw = __name(function (text, id, version, diagObj) {
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    rectangles
      .append('rect')
      .attr('id', (d2) => id + '-exclude-' + d2.start.format('YYYY-MM-DD'))
      .attr('x', (d2) => timeScale(d2.start.startOf('day')) + theSidePad)
      .attr('y', conf.gridLineStartPadding)
      .attr('width', (d2) => timeScale(d2.end.endOf('day')) - timeScale(d2.start.startOf('day')))
...
export { diagram }
//# sourceMappingURL=ganttDiagram-6RSMTGT7-XIHXKIPZ.js.map
