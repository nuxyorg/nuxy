import {
  ...
  markerOffsets,
  markerOffsets2,
} from './chunk-SLZZQQYS.js'
import { createLabel_default } from './chunk-NCFOLWPN.js'
import { getSubGraphTitleMargins } from './chunk-EOLJNIOX.js'
import { at } from './chunk-5G2FUE7H.js'
import { isLabelStyle, styles2String } from './chunk-YGFUTLTO.js'
import { createText } from './chunk-4WLP3MT7.js'
import { handleUndefinedAttr, utils_default } from './chunk-N5H3GFM2.js'
import { getConfig, getConfig2, getEffectiveHtmlLabels } from './chunk-K7N6YW67.js'
import {
  __name,
  basis_default,
  bumpX,
...
var addEdgeMarkers = __name(
  (svgPath, edge, url, id, diagramType, useMargin = false, strokeColor) => {
...
var addEdgeMarker = __name(
  (svgPath, position, arrowType, url, id, diagramType, useMargin = false, strokeColor) => {
    var _a
...
var resolveEdgeCurveType = __name((edgeCurve) => {
  var _a, _b
  return typeof edgeCurve === 'string'
    ? edgeCurve
...
var insertEdge = __name(function (
  elem,
  edge,
  clusterDb,
  diagramType,
  ...
  let strokeColor = edgeStyles.find((style) =>
    style == null ? void 0 : style.startsWith('stroke:')
  )
  let animationClass = ''
  if (edge.animate) {
  ...
  if (edge.look === 'handDrawn') {
    ...
    svgPath = select_default(svgPathNode)
      .select('path')
...
//# sourceMappingURL=chunk-3XC6LI4J.js.map
