import { __export, __name, log, setLogLevel } from './chunk-X4LE64DB.js'
    ...
    return reusable_default.set(
      {
        ...
        a: a
          ? utils_default.channel.clamp.a(isAlphaPercentage ? parseFloat(a) / 100 : parseFloat(a))
          : 1,
      },
      color
    )
...
var RGB = {
  ...
  parse: (color) => {
    ...
    if (!match) return
    const [, r, isRedPercentage, g, isGreenPercentage, b, isBluePercentage, a, isAlphaPercentage] =
      match
    return reusable_default.set(
      {
...
var Color = {
  ...
  parse: (color) => {
    ...
    const channels2 =
      hex_default.parse(color) ||
      rgb_default.parse(color) ||
      hsl_default.parse(color) ||
      keyword_default.parse(color)
  ...
  stringify: (channels2) => {
    ...
    if (channels2.type.is(TYPE.HSL) || channels2.data.r === void 0) {
      ...
      channels2.a < 1 ||
      !Number.isInteger(channels2.r) ||
      !Number.isInteger(channels2.g) ||
      !Number.isInteger(channels2.b)
    ) {
...
var luminance = (color) => {
  ...
  const luminance2 =
    0.2126 * utils_default.channel.toLinear(r) +
    0.7152 * utils_default.channel.toLinear(g) +
    0.0722 * utils_default.channel.toLinear(b)
...
function createDOMPurify() {
  ...
  const _scrubTemplateExpressions2 = function _scrubTemplateExpressions(node) {
    ...
    const templates =
      (_node$querySelectorAl =
        (_node$querySelectorAl2 = node.querySelectorAll) === null ||
        _node$querySelectorAl2 === void 0
          ? void 0
          : _node$querySelectorAl2.call(node, 'template')) !== null &&
  ...
  if (src !== void 0 && typeof dst === 'object' && typeof src === 'object') {
    Object.keys(src).forEach((key) => {
      if (
        ...
        src[key] !== null &&
        (dst[key] === void 0 || typeof dst[key] === 'object')
      ) {
        if (dst[key] === void 0) {
...
var mkBorder = __name(
  (col, darkMode) =>
    darkMode ? adjust_default(col, { s: -40, l: 10 }) : adjust_default(col, { s: -40, l: -10 }),
  'mkBorder'
)
var _a2
var Theme =
  ((_a2 = class {
    ...
    updateColors() {
      ...
      this.edgeLabelBackground =
        this.edgeLabelBackground ||
        (this.darkMode ? darken_default(this.secondaryColor, 30) : this.secondaryColor)
      ...
      this.activationBorderColor =
        this.activationBorderColor || darken_default(this.secondaryColor, 10)
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] ||
          adjust_default(this.mainBkg, { h: 180, s: -15, l: multiplier * (5 + i * 3) })
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
          adjust_default(this.mainBkg, { h: 180, s: -15, l: multiplier * (8 + i * 3) })
      }
      ...
      this.wardley = {
        backgroundColor:
          ((_k = this.wardley) == null ? void 0 : _k.backgroundColor) || this.background,
        axisColor: ((_l = this.wardley) == null ? void 0 : _l.axisColor) || this.lineColor,
        axisTextColor:
          ((_m = this.wardley) == null ? void 0 : _m.axisTextColor) || this.primaryTextColor,
        ...
        componentStroke:
          ((_p = this.wardley) == null ? void 0 : _p.componentStroke) || this.lineColor,
        componentLabelColor:
          ((_q = this.wardley) == null ? void 0 : _q.componentLabelColor) || this.primaryTextColor,
        linkStroke: ((_r = this.wardley) == null ? void 0 : _r.linkStroke) || this.lineColor,
        evolutionStroke:
          ((_s = this.wardley) == null ? void 0 : _s.evolutionStroke) || this.wardleyEvolutionColor,
        annotationStroke:
          ((_t = this.wardley) == null ? void 0 : _t.annotationStroke) || this.lineColor,
        annotationTextColor:
          ((_u = this.wardley) == null ? void 0 : _u.annotationTextColor) || this.primaryTextColor,
        annotationFill:
          ((_v = this.wardley) == null ? void 0 : _v.annotationFill) || this.background,
      }
      ...
      this.quadrant2Fill =
        this.quadrant2Fill || adjust_default(this.primaryColor, { r: 5, g: 5, b: 5 })
      this.quadrant3Fill =
        this.quadrant3Fill || adjust_default(this.primaryColor, { r: 10, g: 10, b: 10 })
      this.quadrant4Fill =
        this.quadrant4Fill || adjust_default(this.primaryColor, { r: 15, g: 15, b: 15 })
      this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor
      this.quadrant2TextFill =
        this.quadrant2TextFill || adjust_default(this.primaryTextColor, { r: -5, g: -5, b: -5 })
      this.quadrant3TextFill =
        this.quadrant3TextFill || adjust_default(this.primaryTextColor, { r: -10, g: -10, b: -10 })
      this.quadrant4TextFill =
        this.quadrant4TextFill || adjust_default(this.primaryTextColor, { r: -15, g: -15, b: -15 })
      this.quadrantPointFill =
        this.quadrantPointFill || is_dark_default(this.quadrant1Fill)
          ? lighten_default(this.quadrant1Fill)
          : darken_default(this.quadrant1Fill)
      ...
      this.xyChart = {
        backgroundColor:
          ((_w = this.xyChart) == null ? void 0 : _w.backgroundColor) || this.background,
        titleColor: ((_x = this.xyChart) == null ? void 0 : _x.titleColor) || this.primaryTextColor,
        dataLabelColor:
          ((_y = this.xyChart) == null ? void 0 : _y.dataLabelColor) || this.primaryTextColor,
        xAxisTitleColor:
          ((_z = this.xyChart) == null ? void 0 : _z.xAxisTitleColor) || this.primaryTextColor,
        xAxisLabelColor:
          ((_A = this.xyChart) == null ? void 0 : _A.xAxisLabelColor) || this.primaryTextColor,
        xAxisTickColor:
          ((_B = this.xyChart) == null ? void 0 : _B.xAxisTickColor) || this.primaryTextColor,
        xAxisLineColor:
          ((_C = this.xyChart) == null ? void 0 : _C.xAxisLineColor) || this.primaryTextColor,
        yAxisTitleColor:
          ((_D = this.xyChart) == null ? void 0 : _D.yAxisTitleColor) || this.primaryTextColor,
        yAxisLabelColor:
          ((_E = this.xyChart) == null ? void 0 : _E.yAxisLabelColor) || this.primaryTextColor,
        yAxisTickColor:
          ((_F = this.xyChart) == null ? void 0 : _F.yAxisTickColor) || this.primaryTextColor,
        yAxisLineColor:
          ((_G = this.xyChart) == null ? void 0 : _G.yAxisLineColor) || this.primaryTextColor,
        plotColorPalette:
          ((_H = this.xyChart) == null ? void 0 : _H.plotColorPalette) ||
...
var Theme2 =
  ((_a3 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] || adjust_default(this.mainBkg, { h: 30, s: -30, l: -(-10 + i * 4) })
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
          adjust_default(this.mainBkg, { h: 30, s: -30, l: -(-7 + i * 4) })
      }
      ...
      this.xyChart = {
        backgroundColor:
          ((_a14 = this.xyChart) == null ? void 0 : _a14.backgroundColor) || this.background,
        titleColor: ((_b = this.xyChart) == null ? void 0 : _b.titleColor) || this.primaryTextColor,
        dataLabelColor:
          ((_c = this.xyChart) == null ? void 0 : _c.dataLabelColor) || this.primaryTextColor,
        xAxisTitleColor:
          ((_d = this.xyChart) == null ? void 0 : _d.xAxisTitleColor) || this.primaryTextColor,
        xAxisLabelColor:
          ((_e = this.xyChart) == null ? void 0 : _e.xAxisLabelColor) || this.primaryTextColor,
        xAxisTickColor:
          ((_f = this.xyChart) == null ? void 0 : _f.xAxisTickColor) || this.primaryTextColor,
        xAxisLineColor:
          ((_g = this.xyChart) == null ? void 0 : _g.xAxisLineColor) || this.primaryTextColor,
        yAxisTitleColor:
          ((_h = this.xyChart) == null ? void 0 : _h.yAxisTitleColor) || this.primaryTextColor,
        yAxisLabelColor:
          ((_i = this.xyChart) == null ? void 0 : _i.yAxisLabelColor) || this.primaryTextColor,
        yAxisTickColor:
          ((_j = this.xyChart) == null ? void 0 : _j.yAxisTickColor) || this.primaryTextColor,
        yAxisLineColor:
          ((_k = this.xyChart) == null ? void 0 : _k.yAxisLineColor) || this.primaryTextColor,
        plotColorPalette:
      ...
      this.wardley = {
        backgroundColor:
          ((_w = this.wardley) == null ? void 0 : _w.backgroundColor) || this.background,
        axisColor: ((_x = this.wardley) == null ? void 0 : _x.axisColor) || this.lineColor,
        axisTextColor:
          ((_y = this.wardley) == null ? void 0 : _y.axisTextColor) || this.primaryTextColor,
        ...
        componentStroke:
          ((_B = this.wardley) == null ? void 0 : _B.componentStroke) || this.lineColor,
        componentLabelColor:
          ((_C = this.wardley) == null ? void 0 : _C.componentLabelColor) || this.primaryTextColor,
        linkStroke: ((_D = this.wardley) == null ? void 0 : _D.linkStroke) || this.lineColor,
        evolutionStroke:
          ((_E = this.wardley) == null ? void 0 : _E.evolutionStroke) || this.wardleyEvolutionColor,
        annotationStroke:
          ((_F = this.wardley) == null ? void 0 : _F.annotationStroke) || this.lineColor,
        annotationTextColor:
          ((_G = this.wardley) == null ? void 0 : _G.annotationTextColor) || this.primaryTextColor,
      ...
      this.emSwimlaneBackgroundOdd =
        this.emSwimlaneBackgroundOdd || lighten_default(this.background, 5)
      this.emSwimlaneBackgroundStroke =
        this.emSwimlaneBackgroundStroke || lighten_default(this.background, 12)
      this.emArrowhead = this.emArrowhead || this.lineColor
      this.emRelationStroke = this.emRelationStroke || this.lineColor
      this.attributeBackgroundColorOdd =
        this.attributeBackgroundColorOdd || lighten_default(this.background, 12)
      this.attributeBackgroundColorEven =
        this.attributeBackgroundColorEven || lighten_default(this.background, 2)
...
var Theme3 =
  ((_a4 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
        this['cScaleInv' + i] =
          this['cScaleInv' + i] || adjust_default(this['cScale' + i], { h: 180 })
      }
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] || adjust_default(this.mainBkg, { h: 30, l: -(5 + i * 5) })
        this['surfacePeer' + i] =
          this['surfacePeer' + i] || adjust_default(this.mainBkg, { h: 30, l: -(7 + i * 5) })
      }
...
var Theme4 =
  ((_a5 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] || adjust_default(this.mainBkg, { h: 30, s: -30, l: -(5 + i * 5) })
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
          adjust_default(this.mainBkg, { h: 30, s: -30, l: -(8 + i * 5) })
      }
      this.nodeBkg = this.mainBkg
      this.nodeBorder = this.border1
      this.clusterBkg = this.secondBkg
...
var Theme5 =
  ((_a6 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] || adjust_default(this.mainBkg, { l: -(5 + i * 5) })
        this['surfacePeer' + i] =
          this['surfacePeer' + i] || adjust_default(this.mainBkg, { l: -(8 + i * 5) })
      }
      this.nodeBkg = this.mainBkg
      this.nodeBorder = this.border1
      this.clusterBkg = this.secondBkg
      ...
      this.wardley = {
        ...
        annotationTextColor:
          ((_G = this.wardley) == null ? void 0 : _G.annotationTextColor) || this.primaryTextColor,
        annotationFill:
          ((_H = this.wardley) == null ? void 0 : _H.annotationFill) || this.background,
      }
      this.requirementBackground = this.requirementBackground || this.primaryColor
      this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor
      this.requirementBorderSize = this.requirementBorderSize || '1'
...
var Theme6 =
  ((_a7 = class {
    ...
    updateColors() {
      ...
      this.quadrant3Fill =
        this.quadrant3Fill || adjust_default(primaryColor, { r: 10, g: 10, b: 10 })
      this.quadrant4Fill =
        this.quadrant4Fill || adjust_default(primaryColor, { r: 15, g: 15, b: 15 })
      this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor
      this.quadrant2TextFill =
        this.quadrant2TextFill || adjust_default(this.primaryTextColor, { r: -5, g: -5, b: -5 })
      this.quadrant3TextFill =
      ...
      this.xyChart = {
        ...
        titleColor: ((_b = this.xyChart) == null ? void 0 : _b.titleColor) || this.primaryTextColor,
        xAxisTitleColor:
          ((_c = this.xyChart) == null ? void 0 : _c.xAxisTitleColor) || this.primaryTextColor,
        xAxisLabelColor:
          ((_d = this.xyChart) == null ? void 0 : _d.xAxisLabelColor) || this.primaryTextColor,
        xAxisTickColor:
          ((_e = this.xyChart) == null ? void 0 : _e.xAxisTickColor) || this.primaryTextColor,
        xAxisLineColor:
          ((_f = this.xyChart) == null ? void 0 : _f.xAxisLineColor) || this.primaryTextColor,
        yAxisTitleColor:
          ((_g = this.xyChart) == null ? void 0 : _g.yAxisTitleColor) || this.primaryTextColor,
        yAxisLabelColor:
          ((_h = this.xyChart) == null ? void 0 : _h.yAxisLabelColor) || this.primaryTextColor,
        yAxisTickColor:
          ((_i = this.xyChart) == null ? void 0 : _i.yAxisTickColor) || this.primaryTextColor,
        yAxisLineColor:
          ((_j = this.xyChart) == null ? void 0 : _j.yAxisLineColor) || this.primaryTextColor,
        plotColorPalette:
          ((_k = this.xyChart) == null ? void 0 : _k.plotColorPalette) ||
          '#FFF4DD,#FFD8B1,#FFA07A,#ECEFF1,#D6DBDF,#C3E0A8,#FFB6A4,#FFD74D,#738FA7,#FFFFF0',
      }
...
var evaluate = __name(
  (val) =>
    val === false || ['false', 'null', '0'].includes(String(val).trim().toLowerCase())
      ? false
      : true,
  'evaluate'
)
...
var addDirective = __name((directive) => {
  ...
  if (
    ...
    !((_a14 = directive.themeVariables) == null ? void 0 : _a14.fontFamily)
  ) {
...
var getEffectiveHtmlLabels = __name((config2) => {
  ...
  return evaluate(
    config2.htmlLabels ?? ((_b = config2.flowchart) == null ? void 0 : _b.htmlLabels) ?? true
  )
...
var sanitizeText = __name((text2, config2) => {
  ...
  if (config2.dompurifyConfig) {
    ...
    text2 = purify
      .sanitize(sanitizeMore(text2, config2), {
        FORBID_TAGS: ['style'],
      })
      .toString()
  }
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import('./katex-UTJ2PKBK.js')
    const outputMode =
      config2.forceLegacyMathML || (!isMathMLSupported() && config2.legacyMathML)
        ? 'htmlAndMathml'
        : 'mathml'
    return text2
...
var DiagramNotFoundError =
  ((_a13 = class extends Error {
    constructor(name) {
      super(`Diagram ${name} not found.`)
    }
  }),
  __name(_a13, 'DiagramNotFoundError'),
  _a13)
...
*/
//# sourceMappingURL=chunk-K7N6YW67.js.map
