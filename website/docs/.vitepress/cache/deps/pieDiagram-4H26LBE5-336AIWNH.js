...
import { cleanAndMerge, parseFontSize } from './chunk-N5H3GFM2.js'
import {
  clear,
  configureSvgSize,
...
import { __name, arc_default, log, ordinal, pie_default } from './chunk-X4LE64DB.js'
...
var draw = __name((text, id, _version, diagObj) => {
  ...
  const longestTextWidth = Math.max(
    ...legend
      .selectAll('text')
      .nodes()
      .map((node) => (node == null ? void 0 : node.getBoundingClientRect().width) ?? 0)
  )
  const chartAndLegendWidth =
    pieWidth + MARGIN + LEGEND_RECT_SIZE + LEGEND_SPACING + longestTextWidth
  const titleWidth =
    ((_a = titleText.node()) == null ? void 0 : _a.getBoundingClientRect().width) ?? 0
...
export { diagram }
//# sourceMappingURL=pieDiagram-4H26LBE5-336AIWNH.js.map
