...
import { cytoscape } from './chunk-U2ZJCB25.js'
import { require_cytoscape_cose_bilkent } from './chunk-LNXV3XX7.js'
  ...
  async (
    ...
    layoutResult.nodes.forEach((positionedNode) => {
      ...
      if (node == null ? void 0 : node.domId) {
        ...
        log2.debug(
          `Positioned node ${node.id} at center (${positionedNode.x}, ${positionedNode.y})`
        )
      }
    })
...
//# sourceMappingURL=cose-bilkent-S5V4N54A-VM6XH4MJ.js.map
