...
var draw = __name((_text, id, _version, diagram2) => {
  ...
  const treemapLayout = treemap_default()
    .size([width, height])
    .paddingTop((d) =>
  ...
  sections
    ...
    .append('rect')
    .attr('width', (d) => Math.max(0, d.x1 - d.x0 - 12))
    .attr('height', SECTION_HEADER_HEIGHT)
  sections
    .append('rect')
    .attr('width', (d) => d.x1 - d.x0)
  ...
  setupViewPortForSVG(
    ...
    diagramPadding,
    'flowchart',
    (config == null ? void 0 : config.useMaxWidth) || false
  )
}, 'draw')
...
var getStyles = __name(({ treemap: treemap2 } = {}) => {
...
export { diagram }
//# sourceMappingURL=diagram-OG6HWLK6-MFGRJDNL.js.map
