...
import { parseFontSize } from './chunk-N5H3GFM2.js'
import {
  clear,
  commonDb_exports,
  darken_default,
...
import { __export, __name, arc_default, log, select_default } from './chunk-X4LE64DB.js'
...
var parser = (function () {
  var o = __name(function (k, v, o2, l) {
    ...
    $V0 = [6, 11, 13, 14, 15, 17, 19, 20, 23, 24],
    $V1 = [1, 12],
    $V2 = [1, 13],
    $V3 = [1, 14],
    $V4 = [1, 15],
  ...
  var parser2 = {
    ...
    table: [
      ...
      o($V0, [2, 10], { 1: [2, 1] }),
      o($V0, [2, 6]),
      { 12: 21, 14: $V1, 15: $V2, 17: $V3, 19: $V4, 20: $V5, 21: 17, 22: 18, 23: $V6, 24: $V7 },
      o($V0, [2, 8]),
      o($V0, [2, 9]),
      o($V0, [2, 11]),
      { 16: [1, 22] },
  ...
  var lexer = (function () {
    var lexer2 = {
      ...
      conditions: {
        acc_descr_multiline: { rules: [14, 15], inclusive: false },
        acc_descr: { rules: [12], inclusive: false },
        acc_title: { rules: [10], inclusive: false },
        INITIAL: {
...
var drawNode = __name(function (elem, node, fullSection, conf, diagramId, isEvent = false) {
  ...
  const maxSections =
    ((_a = conf == null ? void 0 : conf.themeVariables) == null ? void 0 : _a.THEME_COLOR_LIMIT) ??
    12
  ...
  const fontSize = ((_b = conf.fontSize) == null ? void 0 : _b.replace)
    ...
    if (isReduxTheme) {
      ...
      if (rootSvg.select(`#${dropShadowId}`).empty()) {
        ...
        defsEl
          ...
          .attr('dy', '4')
          .attr('stdDeviation', 0)
          .attr('flood-opacity', isDark2 ? '0.2' : '0.06')
          .attr('flood-color', isDark2 ? '#FFFFFF' : '#000000')
      }
    }
  }
  return node
...
var drawTasks = __name(function (
  ...
  for (const task of tasks2) {
    ...
    if (task.events) {
      ...
      lineLength =
        lineLength +
        drawEvents(diagram2, task.events, sectionColor, masterX, masterY, conf, diagramId)
      masterY -= 100
      lineWrapper
        .append('line')
  ...
  if (hasSections) {
    sections2.forEach((section) => {
      ...
      const sectionHeight =
        node.height +
        SECTION_TASK_GAP +
        taskSpacing * Math.max(taskCount2, 1) -
        (taskCount2 > 0 ? TASK_VERTICAL_GAP * 2 : 0)
...
var drawTasks2 = __name(function (
  diagram2,
  tasks2,
  sectionColor,
  timelineX,
...
var rendererSelector = {
  ...
  draw: __name((text, id, version, diagObj) => {
    var _a, _b
    const direction2 =
      ((_b = (_a = diagObj == null ? void 0 : diagObj.db) == null ? void 0 : _a.getDirection) ==
      null
        ? void 0
        : _b.call(_a)) ?? 'LR'
    if (direction2 === 'TD') {
...
export { diagram }
//# sourceMappingURL=timeline-definition-PNZ67QCA-RRIIIWWJ.js.map
