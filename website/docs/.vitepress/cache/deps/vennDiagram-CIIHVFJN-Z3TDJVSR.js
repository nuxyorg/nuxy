...
import { __name, select_default } from './chunk-X4LE64DB.js'
...
function VennDiagram(options = {}) {
  let useViewBox = false,
    ...
    symmetricalTextCentre =
      options && options.symmetricalTextCentre ? options.symmetricalTextCentre : false,
    colourMap = {},
    colourScheme =
  ...
  function chart(selection) {
    ...
    if (hasPrevious && typeof update.transition === 'function') {
      ...
      update
        .selectAll('path')
        .attr('d', (d) => intersectionAreaPath(d.sets.map((set) => circles[set])), round)
    }
...
var parser = (function () {
  ...
  var parser2 = {
    ...
    table: [
      ...
      o($V1, [2, 21]),
      { 20: $V6, 26: 51 },
      { 16: $V8, 20: $V9, 21: [1, 53], 28: 52, 29: 54, 30: 55, 31: $Va, 32: $Vb, 33: $Vc },
      o($V1, [2, 12]),
      o($V1, [2, 16]),
      o($V7, [2, 30]),
      o($V7, [2, 31]),
...
var draw = __name((_text, id, _version, diagObj) => {
  ...
  dummyD3root.selectAll('.venn-circle').each(function (d, i) {
    ...
    const strokeWidthVal =
      (customStyle == null ? void 0 : customStyle['stroke-width']) || `${5 * scale2}`
    ...
    const textColor =
      ...
      (themeDark ? lighten_default(baseColor, 30) : darken_default(baseColor, 30))
    group
      .select('text')
    ...
    dummyD3root.selectAll('.venn-intersection').each(function (d) {
      ...
      if (customFill) {
        ...
        if (pathD) {
          ...
          ;(_a2 = existingPath == null ? void 0 : existingPath.parentNode) == null
            ? void 0
...
export { diagram }
//# sourceMappingURL=vennDiagram-CIIHVFJN-Z3TDJVSR.js.map
