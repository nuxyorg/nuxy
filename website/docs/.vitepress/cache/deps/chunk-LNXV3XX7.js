          ...
          function (module2, exports2, __webpack_require__) {
            ...
            CoSENode.prototype.move = function () {
              ...
              if (
                ...
                this.displacementX =
                  layout.coolingFactor * layout.maxNodeDisplacement * IMath.sign(this.displacementX)
              }
              if (
                ...
                this.displacementY =
                  layout.coolingFactor * layout.maxNodeDisplacement * IMath.sign(this.displacementY)
              }
              if (this.child == null) {
            ...
            CoSELayout.prototype.initParameters = function () {
              ...
              if (!this.isSubLayout) {
                ...
                this.finalTemperature =
                  FDLayoutConstants.CONVERGENCE_CHECK_PERIOD / this.maxIterations
            ...
            CoSELayout.prototype.findPlaceforPrunedNode = function (nodeData) {
              ...
              if (finishGridX < this.grid.length - 1) {
                for (var i = startGridY; i <= finishGridY; i++) {
                  controlRegions[1] +=
                    this.grid[finishGridX + 1][i].length + this.grid[finishGridX][i].length - 1
                }
              }
              if (finishGridY < this.grid[0].length - 1) {
                for (var i = startGridX; i <= finishGridX; i++) {
                  controlRegions[2] +=
                    this.grid[i][finishGridY + 1].length + this.grid[i][finishGridY].length - 1
                }
              }
              if (startGridX > 0) {
                for (var i = startGridY; i <= finishGridY; i++) {
          ...
          function (module2, exports2, __webpack_require__) {
            ...
            var getUserOptions = function getUserOptions2(options) {
              ...
              if (options.edgeElasticity != null)
                CoSEConstants.DEFAULT_SPRING_STRENGTH = FDLayoutConstants.DEFAULT_SPRING_STRENGTH =
...
export { require_cytoscape_cose_bilkent }
//# sourceMappingURL=chunk-LNXV3XX7.js.map
