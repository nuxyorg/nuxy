  ...
  if (type === 'mathord') {
    ...
    if (_font === 'ams') {
      ...
      return makeSymbol(
        ...
        mode,
        options,
        classes.concat(_fontName3, fontWeight, fontShape)
      )
    }
  } else {
...
var makeText = function makeText2(text2, mode, options) {
  if (
    symbols[mode][text2] &&
    symbols[mode][text2].replace &&
    text2.charCodeAt(0) !== 55349 &&
    !(
      ligatures.hasOwnProperty(text2) &&
      options &&
...
var htmlBuilder$a = (grp, options) => {
  ...
  if (mustShift) {
    ...
    skew =
      (_getBaseSymbol$skew =
        (_getBaseSymbol = getBaseSymbol(body)) == null ? void 0 : _getBaseSymbol.skew) != null
        ? _getBaseSymbol$skew
        : 0
  }
...
var makeStackedDelim = function makeStackedDelim2(
  delim,
  heightTotal,
  center,
  options,
...
var makeCustomSizedDelim = function makeCustomSizedDelim2(
  delim,
  height,
  center,
  options,
...
var makeLeftRightDelim = function makeLeftRightDelim2(
  delim,
  height,
  depth,
  options,
...
var htmlBuilder$6 = function htmlBuilder(group, options) {
  ...
  for (
    ...
    if (c > 0 || group.hskipBeforeAndAfter) {
      ...
      sepwidth =
        (_colDescr$pregap = (_colDescr2 = colDescr) == null ? void 0 : _colDescr2.pregap) != null
          ? _colDescr$pregap
          : arraycolsep
      if (sepwidth !== 0) {
        colSep = makeSpan(['arraycolsep'], [])
    ...
    if (c < nc - 1 || group.hskipBeforeAndAfter) {
      ...
      sepwidth =
        (_colDescr$postgap = (_colDescr4 = colDescr) == null ? void 0 : _colDescr4.postgap) != null
          ? _colDescr$postgap
          : arraycolsep
      if (sepwidth !== 0) {
        colSep = makeSpan(['arraycolsep'], [])
...
var mathmlBuilder$5 = function mathmlBuilder(group, options) {
  ...
  var gap =
    group.arraystretch === 0.5 ? 0.1 : 0.16 + group.arraystretch - 1 + (group.addJot ? 0.09 : 0)
...
defineFunction({
  ...
  mathmlBuilder(group, options) {
    ...
    return index
      ? new MathNode('mroot', [buildGroup2(body, options), buildGroup2(index, options)])
      : new MathNode('msqrt', [buildGroup2(body, options)])
  },
})
var styleMap = {
  display: Style$1.DISPLAY,
...
var Parser = class _Parser {
  ...
  expect(text2, consume) {
    ...
    if (this.fetch().text !== text2) {
      throw new ParseError(
        "Expected '" + text2 + "', got '" + this.fetch().text + "'",
        this.fetch()
      )
    }
    if (consume) {
  ...
  parseSymbol() {
    ...
    if (symbols[this.mode][text2]) {
      if (this.settings.strict && this.mode === 'math' && extraLatin.includes(text2)) {
        this.settings.reportNonstrict(
          'unicodeTextInMathMode',
          'Latin-1/Unicode text character "' + text2[0] + '" used in math mode',
          nucleus
        )
      }
      ...
      if (this.settings.strict) {
        if (!supportedCodepoint(text2.charCodeAt(0))) {
          ...
          this.settings.reportNonstrict(
            'unicodeTextInMathMode',
            'Unicode text character "' + text2[0] + '" used in math mode',
            nucleus
          )
        }
      }
...
//# sourceMappingURL=katex-UTJ2PKBK.js.map
