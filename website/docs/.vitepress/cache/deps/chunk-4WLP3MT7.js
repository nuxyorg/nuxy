import { decodeEntities } from './chunk-N5H3GFM2.js'
import {
  common_default,
  getConfig,
  hasKatex,
    ...
    if (matches) {
      return arr.concat(
        matches.map(function (match) {
          var _a2, _b
          return (_b =
            (_a2 = match.match(/[\t ]/g)) === null || _a2 === void 0 ? void 0 : _a2.length) !==
            null && _b !== void 0
            ? _b
            : 0
        })
...
var m = {
  ...
  nextBulletRegex: (l3) =>
    new RegExp(`^ {0,${Math.min(3, l3 - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),
  hrRegex: (l3) =>
    new RegExp(`^ {0,${Math.min(3, l3 - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),
...
function V(l3, e) {
  ...
  if (
    (n[0].trim() || n.shift(),
    n.length > 0 && !((_a2 = n.at(-1)) == null ? void 0 : _a2.trim()) && n.pop(),
    e)
  )
...
function me(l3, e, t, n, r) {
  let i = e.href,
    s = e.title || null,
    a = l3[1].replace(r.other.outputLinkReplace, '$1')
  n.state.inLink = true
  let o = {
...
`),
      ...
      for (; n.length > 0; ) {
        ...
        for (p = 0; p < n.length; p++)
          if (this.rules.other.blockquoteStart.test(n[p])) (o.push(n[p]), (a = true))
...
`,
            ...
            .replace(this.rules.other.listReplaceTabs, (H) => ' '.repeat(3 * H.length)),
          h = e.split(
            `
`,
            1
...
`,
            ...
            if (
              ...
              te.test(h) || ne.test(h) || xe.test(h) || H.test(h) || ee.test(h))
            )
              break
...
`),
        ...
        let O = null,
          Y
        ;(this.options.gfm &&
          ((O = this.rules.other.listIsTask.exec(c)),
          O && ((Y = O[0] !== '[ ] '), (c = c.replace(this.rules.other.listReplaceTask, '')))),
          i.items.push({
            type: 'list_item',
            raw: u,
            task: !!O,
      ...
      for (let p = 0; p < i.items.length; p++)
        if (
          ...
          let u = i.items[p].tokens.filter((g) => g.type === 'space'),
            c = u.length > 0 && u.some((g) => this.rules.other.anyLine.test(g.raw))
          i.loose = c
        }
  ...
  table(e) {
    ...
    let n = V(t[1]),
      ...
      i = ((_a2 = t[3]) == null ? void 0 : _a2.trim())
    ...
    if ((t = this.rules.inline.url.exec(e))) {
      ...
      if (t[2] === '@') ((n = t[0]), (r = 'mailto:' + n))
        ...
        do
          ((i = t[0]),
            (t[0] =
              ((_a2 = this.rules.inline._backpedal.exec(t[0])) == null ? void 0 : _a2[0]) ?? ''))
        while (i !== t[0])
...
var x = class l {
  constructor(e) {
    ...
    ;(this.options.pedantic
      ? ((t.block = C.pedantic), (t.inline = M.pedantic))
      : this.options.gfm &&
        ((t.block = C.gfm), this.options.breaks ? (t.inline = M.breaks) : (t.inline = M.gfm)),
...
`
  ...
  blockTokens(e, t = [], n = false) {
    ...
    for (
      ...
      let r
      if (
        (_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.block) == null
          ? void 0
          : _b.some((s) =>
...
`)
      ...
      if ((r = this.tokenizer.code(e))) {
        e = e.substring(r.raw.length)
        let s = t.at(-1)
        ;(s == null ? void 0 : s.type) === 'paragraph' || (s == null ? void 0 : s.type) === 'text'
          ? ((s.raw +=
              (s.raw.endsWith(`
`)
                ? ''
...
` + r.raw),
      ...
      if (this.state.top && (r = this.tokenizer.paragraph(i))) {
        let s = t.at(-1)
        ;(n && (s == null ? void 0 : s.type) === 'paragraph'
          ? ((s.raw +=
              (s.raw.endsWith(`
`)
                ? ''
...
` + r.text),
  ...
  inlineTokens(e, t = []) {
    ...
    n =
      ((_b = (_a2 = this.options.hooks) == null ? void 0 : _a2.emStrongMask) == null
        ? void 0
        : _b.call({ lexer: this }, n)) ?? n
    let s = false,
      a = ''
    for (; e; ) {
      ;(s || (a = ''), (s = false))
      let o
      if (
        (_d = (_c = this.options.extensions) == null ? void 0 : _c.inline) == null
          ? void 0
          : _d.some((u) =>
      ...
      if ((o = this.tokenizer.reflink(e, this.tokens.links))) {
        ...
        let u = t.at(-1)
        o.type === 'text' && (u == null ? void 0 : u.type) === 'text'
...
var P = class {
  ...
  code({ text: e, lang: t, escaped: n }) {
    var _a2
    let r = (_a2 = (t || '').match(m.notSpaceStart)) == null ? void 0 : _a2[0],
      i =
...
`
  ...
  listitem(e) {
    ...
    if (e.task) {
      ...
      e.loose
        ? ((_a2 = e.tokens[0]) == null ? void 0 : _a2.type) === 'paragraph'
          ...
          : e.tokens.unshift({ type: 'text', raw: n + ' ', text: n + ' ', escaped: true })
        : (t += n + ' ')
    }
    return (
...
var b = class l2 {
  ...
  parse(e, t = true) {
    ...
    for (let r = 0; r < e.length; r++) {
      let i = e[r]
      if (
        (_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.renderers) == null
          ? void 0
          : _b[i.type]
      ) {
        let a = i,
...
var S =
  ...
  __publicField(
    _a,
    'passThroughHooks',
    /* @__PURE__ */ new Set(['preprocess', 'postprocess', 'processAllTokens', 'emStrongMask'])
  ),
  __publicField(
    _a,
    ...
    for (let r of e)
      switch (((n = n.concat(t.call(this, r))), r.type)) {
        ...
        default: {
          let i = r
          ;(
            (_b = (_a2 = this.defaults.extensions) == null ? void 0 : _a2.childTokens) == null
              ? void 0
              : _b[i.type]
          )
      ...
      if ((s.hooks && ((s.hooks.options = s), (s.hooks.block = e)), s.async))
        return (async () => {
          let o = s.hooks ? await s.hooks.preprocess(n) : n,
            u = await (s.hooks ? await s.hooks.provideLexer() : e ? x.lex : x.lexInline)(o, s),
            c = s.hooks ? await s.hooks.processAllTokens(u) : u
...
var getIconSVG = __name(async (iconName, customisations, extraAttributes) => {
  let iconData
  try {
    iconData = await getRegisteredIconData(
      iconName,
      customisations == null ? void 0 : customisations.fallbackPrefix
    )
  } catch (e) {
    log.error(e)
...
function nonMarkdownToLines(nonMarkdownText) {
  return nonMarkdownText.split(/\\n|\n|<br\s*\/?>/gi).map((line) => {
    var _a2
    return (
      ((_a2 = line.trim().match(/<[^>]+>|[^\s<>]+/g)) == null
        ? void 0
        : _a2.map((word) => ({ content: word, type: 'normal' }))) ?? []
    )
  })
}
...
function markdownToLines(markdown, config = {}) {
  ...
  nodes.forEach((treeNode) => {
    ...
    if (treeNode.type === 'paragraph') {
      ;(_a2 = treeNode.tokens) == null
        ? void 0
        : _a2.forEach((contentNode) => {
...
async function addHtmlSpan(
  ...
  const sanitizedLabel = hasKatex(node.label)
    ? await renderKatexSanitized(node.label.replace(common_default.lineBreakRegex, '\n'), config)
...
function createFormattedText(width, g, structuredText, addBackground = false, centerText = false) {
  ...
  for (const line of structuredText) {
    const checkWidth = __name(
      (line2) => computeWidthOfText(labelGroup, lineHeight, line2) <= width,
      'checkWidth'
    )
...
//# sourceMappingURL=chunk-4WLP3MT7.js.map
