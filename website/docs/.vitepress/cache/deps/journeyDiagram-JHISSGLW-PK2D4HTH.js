...
import { drawBackgroundRect, drawRect, drawText, getNoteRect } from './chunk-5FWDYVY7.js'
import {
  clear,
  configureSvgSize,
  getAccDescription,
...
import { __name, arc_default, select_default } from './chunk-X4LE64DB.js'
...
var parser = (function () {
  ...
  var parser2 = {
    ...
    table: [
      ...
      o($V0, [2, 7], { 1: [2, 1] }),
      o($V0, [2, 3]),
      { 9: 15, 11: $V1, 12: $V2, 14: $V3, 16: $V4, 17: $V5, 18: $V6 },
      o($V0, [2, 5]),
      o($V0, [2, 6]),
      o($V0, [2, 8]),
      { 13: [1, 16] },
...
var drawSection = __name(function (elem, section, conf2) {
  ...
  rect.width =
    conf2.width * section.taskCount + // width of the tasks
...
var draw = __name(function (text, id, version, diagObj) {
  ...
  diagram2
    .append('line')
    .attr('x1', leftMargin)
    .attr('y1', conf.height * 4)
    .attr('x2', width - leftMargin - 4)
...
export { diagram }
//# sourceMappingURL=journeyDiagram-JHISSGLW-PK2D4HTH.js.map
