...
import { cleanAndMerge, random, utils_default } from './chunk-N5H3GFM2.js'
import {
  clear,
  common_default,
...
var state = new ImperativeState(() => {
  ...
  return {
    ...
    branchConfig: /* @__PURE__ */ new Map([
      [mainBranchName, { name: mainBranchName, order: mainBranchOrder }],
    ]),
...
var parseCherryPicking = __name((cherryPicking) => {
  ...
  const cherryPickDB = {
    ...
    targetId: '',
    tags:
      ((_a = cherryPicking.tags) == null ? void 0 : _a.length) === 0 ? void 0 : cherryPicking.tags,
...
var findClosestParent = __name((parents) => {
  ...
  parents.forEach((parent) => {
    ...
    const parentPosition =
      dir === 'TB' || dir == 'BT'
        ? (_a = commitPos.get(parent)) == null
          ? void 0
          : _a.y
        : (_b = commitPos.get(parent)) == null
          ? void 0
          : _b.x
...
var drawCommitBullet = __name(
  (gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
    ...
    if (commitSymbolType === commitType.HIGHLIGHT) {
      ...
      gBullets
        ...
        .attr('class', `commit ${commit2.id} ${typeClass}`)
      gBullets
        .append('circle')
...
var drawCommitLabel = __name((gLabels, commit2, commitPosition, pos, gitGraphConfig) => {
  var _a
  if (
    commit2.type !== commitType.CHERRY_PICK &&
    ((commit2.customId && commit2.type === commitType.MERGE) ||
      commit2.type !== commitType.MERGE) &&
...
var getCommitPosition = __name((commit2, pos, isParallelCommits) => {
  ...
  const x =
    dir === 'TB' || dir === 'BT'
      ? (_b = branchPos.get(commit2.branch)) == null
        ? void 0
        : _b.pos
      : posWithOffset
...
var shouldRerouteArrow = __name((commitA, commitB, p1, p2, allCommits) => {
  ...
  const isBetweenCommits = __name(
    (x) => x.seq > commitA.seq && x.seq < commitB.seq,
    'isBetweenCommits'
  )
...
var drawArrow = __name((svg, commitA, commitB, allCommits) => {
  ...
  svg
    .append('path')
    .attr('d', lineDef)
    .attr('class', 'arrow arrow' + calcColorIndex(colorClassNum, THEME_COLOR_LIMIT, useColorTheme))
}, 'drawArrow')
...
export { diagram }
//# sourceMappingURL=gitGraphDiagram-PVQCEYII-2W5WGMMB.js.map
