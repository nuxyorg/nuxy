...
import { Tableau10_default, __name, ordinal, select_default } from './chunk-X4LE64DB.js'
...
function max(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    for (let value2 of values) {
      if (
        (value2 = valueof(value2, ++index2, values)) != null &&
        (max3 < value2 || (max3 === void 0 && value2 >= value2))
      ) {
        max3 = value2
      }
    }
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    for (let value2 of values) {
      if (
        (value2 = valueof(value2, ++index2, values)) != null &&
        (min3 > value2 || (min3 === void 0 && value2 >= value2))
      ) {
        min3 = value2
      }
    }
...
function Sankey() {
  ...
  sankey.nodes = function (_) {
    return arguments.length
      ? ((nodes2 = typeof _ === 'function' ? _ : constant(_)), sankey)
      : nodes2
  }
  sankey.links = function (_) {
    return arguments.length
      ? ((links2 = typeof _ === 'function' ? _ : constant(_)), sankey)
      : links2
  }
  ...
  function reorderNodeLinks({ sourceLinks, targetLinks }) {
    if (linkSort === void 0) {
      for (const {
        source: { sourceLinks: sourceLinks2 },
      } of targetLinks) {
        sourceLinks2.sort(ascendingTargetBreadth)
      }
      for (const {
        target: { targetLinks: targetLinks2 },
      } of sourceLinks) {
...
Path.prototype = path.prototype = {
  ...
  rect: function (x2, y2, w, h) {
    this._ +=
      'M' +
      (this._x0 = this._x1 = +x2) +
      ',' +
      (this._y0 = this._y1 = +y2) +
      'h' +
      +w +
      'v' +
      +h +
...
function link(curve) {
  ...
  function link2() {
    ...
    curve(
      context,
      +x2.apply(this, ((argv[0] = s2), argv)),
      +y2.apply(this, argv),
      +x2.apply(this, ((argv[0] = t), argv)),
      +y2.apply(this, argv)
    )
  ...
  link2.x = function (_) {
    return arguments.length
      ? ((x2 = typeof _ === 'function' ? _ : constant_default2(+_)), link2)
      : x2
  }
  link2.y = function (_) {
    return arguments.length
      ? ((y2 = typeof _ === 'function' ? _ : constant_default2(+_)), link2)
      : y2
  }
...
var parser = (function () {
  ...
  var parser2 = {
    ...
    table: [
      ...
      { 1: [3] },
      { 5: [1, 3] },
      { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: $V0, 20: $V1 },
      { 1: [2, 6], 7: 11, 10: [1, 12] },
      o($V1, [2, 4], { 9: 13, 5: [1, 14] }),
      { 12: [1, 15] },
      o($V2, [2, 8]),
      o($V2, [2, 9]),
      { 19: [1, 16] },
      ...
      { 1: [2, 5] },
      o($V1, [2, 2]),
      { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: $V0, 20: $V1 },
      { 15: 18, 16: 7, 17: 8, 18: $V0, 20: $V1 },
      { 18: [1, 19] },
      o($V1, [2, 3]),
      { 12: [1, 20] },
      o($V2, [2, 10]),
      { 15: 21, 16: 7, 17: 8, 18: $V0, 20: $V1 },
      o([1, 5, 10], [2, 7]),
    ],
  ...
  var lexer = (function () {
    var lexer2 = {
      ...
      conditions: {
        csv: { rules: [2, 3, 4, 5, 6, 7, 8], inclusive: false },
        escaped_text: { rules: [7, 8], inclusive: false },
...
var draw = __name(function (text, id, _version, diagObj) {
  ...
  const nodeAlignment =
    (conf == null ? void 0 : conf.nodeAlignment) ?? defaultSankeyConfig.nodeAlignment
  ...
  const nodePadding =
    (conf == null ? void 0 : conf.nodePadding) ?? defaultSankeyConfig.nodePadding ?? 12
  const labelStyle =
    (conf == null ? void 0 : conf.labelStyle) ?? defaultSankeyConfig.labelStyle ?? 'legacy'
  ...
  svg
    ...
    .join('g')
    .attr('class', 'node')
    .attr('id', (d) => (d.uid = Uid.next('node-')).id)
...
${prefix}${Math.round(value2 * 100) / 100}${suffix}`
  ...
  const appendLabel = __name(
    (className) =>
      labelsGroup
        ...
        .attr('text-anchor', (d) => getLabelPosition(d).anchor)
        .text(getText),
    'appendLabel'
  )
  if (labelStyle === 'outlined') {
  ...
  if (linkColor === 'gradient') {
    ...
    gradient
      .append('stop')
      .attr('offset', '0%')
      .attr('stop-color', (d) => getNodeColor(d.source.id))
    gradient
      .append('stop')
      .attr('offset', '100%')
      .attr('stop-color', (d) => getNodeColor(d.target.id))
  }
  let coloring
  switch (linkColor) {
    case 'gradient':
  ...
  link2
    .append('path')
    .attr('d', sankeyLinkHorizontal_default())
...
export { diagram }
//# sourceMappingURL=sankeyDiagram-5OEKKPKP-LPYPCPU7.js.map
