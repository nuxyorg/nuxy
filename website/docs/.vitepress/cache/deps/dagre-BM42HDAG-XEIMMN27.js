...
import { Graph, clone_default, isUndefined_default, map_default } from './chunk-XRKU4FFT.js'
import {
  clear as clear3,
  insertEdge,
  insertEdgeLabel,
...
import './chunk-N5H3GFM2.js'
import { getConfig2 } from './chunk-K7N6YW67.js'
...
var extractor = __name((graph, depth) => {
  ...
  for (const node of nodes) {
    ...
    if (!clusterDb.has(node)) {
      ...
      if (
        (_b = (_a = clusterDb.get(node)) == null ? void 0 : _a.clusterData) == null
          ? void 0
          : _b.dir
      ) {
...
var sortNodesByHierarchy = __name(
  (graph) => sorter(graph, graph.children()),
    ...
    sortNodesByHierarchy(graph).map(async function (v) {
      ...
      if (node == null ? void 0 : node.clusterNode) {
        ...
        if (graph.children(v).length > 0) {
          ...
          const labelHeight =
            ((_a = node == null ? void 0 : node.labelBBox) == null ? void 0 : _a.height) || 0
...
var render = __name(async (data4Layout, svg) => {
  ...
  const graph = new Graph({
    ...
    .setGraph({
      ...
      nodesep:
        ((_a = data4Layout.config) == null ? void 0 : _a.nodeSpacing) ||
        ((_c = (_b = data4Layout.config) == null ? void 0 : _b.flowchart) == null
          ? void 0
          : _c.nodeSpacing) ||
        data4Layout.nodeSpacing,
      ranksep:
        ((_d = data4Layout.config) == null ? void 0 : _d.rankSpacing) ||
        ((_f = (_e = data4Layout.config) == null ? void 0 : _e.flowchart) == null
          ? void 0
          : _f.rankSpacing) ||
...
export { render }
//# sourceMappingURL=dagre-BM42HDAG-XEIMMN27.js.map
