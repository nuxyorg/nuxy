...
function t(t2, e2, s2) {
  if (t2 && t2.length) {
    ...
    for (const e3 of t2) {
      const [t3, s3] = e3
      ;((e3[0] = (t3 - n2) * h2 - (s3 - o2) * r2 + n2),
        (e3[1] = (t3 - n2) * r2 + (s3 - o2) * h2 + o2))
    }
  }
}
function e(t2, e2) {
...
function s(s2, n2, o2, a2 = 1) {
  const h2 = o2,
    r2 = Math.max(n2, 0.1),
    i2 = s2[0] && s2[0][0] && 'number' == typeof s2[0][0] ? [s2] : s2,
    c2 = [0, 0]
  ...
  const l2 = (function (t2, s3, n3) {
          ...
          : t3.ymin > e2.ymin
            ...
            : t3.x < e2.x
              ...
              : t3.x > e2.x
                ...
                : t3.ymax === e2.ymax
                  ? 0
                  : (t3.ymax - e2.ymax) / Math.abs(t3.ymax - e2.ymax)
      ),
      !h3.length)
    )
      return a3
    ...
    for (; r3.length || h3.length; ) {
      ...
      if (
        ((r3 = r3.filter((t3) => !(t3.edge.ymax <= i3))),
        r3.sort((t3, e2) =>
          t3.edge.x === e2.edge.x ? 0 : (t3.edge.x - e2.edge.x) / Math.abs(t3.edge.x - e2.edge.x)
        ),
        (1 !== n3 || c3 % s3 == 0) && r3.length > 1)
      )
...
function n(t2, e2) {
  ...
  return (
    e2.roughness >= 1 &&
      ((null === (n2 = e2.randomizer) || void 0 === n2 ? void 0 : n2.next()) || Math.random()) >
        0.7 &&
      (h2 = a2),
    s(t2, a2, o2, h2 || 1)
  )
...
var h = class extends o {
  fillPolygons(t2, e2) {
    ...
    const o2 = n(t2, Object.assign({}, e2, { hachureGap: s2 })),
      h2 = (Math.PI / 180) * e2.hachureAngle,
      r2 = [],
      i2 = 0.5 * s2 * Math.cos(h2),
      c2 = 0.5 * s2 * Math.sin(h2)
    for (const [t3, e3] of o2)
      a([t3, e3]) &&
        r2.push([[t3[0] - i2, t3[1] + c2], [...e3]], [[t3[0] + i2, t3[1] - c2], [...e3]])
    return { type: 'fillSketch', ops: this.renderLines(r2, e2) }
  }
}
var r = class extends o {
  fillPolygons(t2, e2) {
    const s2 = this._fillPolygons(t2, e2),
      n2 = Object.assign({}, e2, { hachureAngle: e2.hachureAngle + 90 }),
  ...
  dotsOnLines(t2, e2) {
    ...
    for (const r2 of t2) {
      const t3 = a(r2),
        ...
        c2 = Math.ceil(i2) - 1,
        l2 = t3 - c2 * n2,
        u2 = (r2[0][0] + r2[1][0]) / 2 - n2 / 4,
        p2 = Math.min(r2[0][1], r2[1][1])
      for (let t4 = 0; t4 < c2; t4++) {
        const a2 = p2 + l2 + t4 * n2,
          r3 = u2 - h2 + 2 * Math.random() * h2,
          i3 = a2 - h2 + 2 * Math.random() * h2,
          c3 = this.helper.ellipse(r3, i3, o2, o2, e2)
        s2.push(...c3.ops)
      }
    }
    ...
    const s2 =
        e2.dashOffset < 0
          ? e2.hachureGap < 0
            ...
            : e2.hachureGap
          : e2.dashOffset,
      n2 = e2.dashGap < 0 ? (e2.hachureGap < 0 ? 4 * e2.strokeWidth : e2.hachureGap) : e2.dashGap,
      o2 = []
    return (
      t2.forEach((t3) => {
        const h2 = a(t3),
          r2 = Math.floor(h2 / (s2 + n2)),
          i2 = (h2 + n2 - r2 * (s2 + n2)) / 2
        let c2 = t3[0],
          l2 = t3[1]
        ...
        for (let t4 = 0; t4 < r2; t4++) {
          const a2 = t4 * (s2 + n2),
            h3 = a2 + s2,
            r3 = [
              c2[0] + a2 * Math.cos(u2) + i2 * Math.cos(u2),
              c2[1] + a2 * Math.sin(u2) + i2 * Math.sin(u2),
            ],
            l3 = [
              c2[0] + h3 * Math.cos(u2) + i2 * Math.cos(u2),
              c2[1] + h3 * Math.sin(u2) + i2 * Math.sin(u2),
            ]
...
var l = class {
  ...
  fillPolygons(t2, e2) {
    const s2 = e2.hachureGap < 0 ? 4 * e2.strokeWidth : e2.hachureGap,
      o2 = e2.zigzagOffset < 0 ? s2 : e2.zigzagOffset,
      a2 = n(t2, (e2 = Object.assign({}, e2, { hachureGap: s2 + o2 })))
    ...
    return (
      t2.forEach((t3) => {
        ...
        for (let t4 = 0; t4 < h2; t4++) {
          const o3 = 2 * t4 * e2,
            a2 = 2 * (t4 + 1) * e2,
            h3 = Math.sqrt(2 * Math.pow(e2, 2)),
            i3 = [r2[0] + o3 * Math.cos(c2), r2[1] + o3 * Math.sin(c2)],
            l2 = [r2[0] + a2 * Math.cos(c2), r2[1] + a2 * Math.sin(c2)],
            u2 = [i3[0] + h3 * Math.cos(c2 + Math.PI / 4), i3[1] + h3 * Math.sin(c2 + Math.PI / 4)]
          n2.push(
            ...this.helper.doubleLineOps(i3[0], i3[1], u2[0], u2[1], s2),
            ...this.helper.doubleLineOps(u2[0], u2[1], l2[0], l2[1], s2)
          )
        }
      }),
      n2
    ...
    s2 = (function (t3) {
      ...
      for (; '' !== t3; )
        if (t3.match(/^([ \t\r\n,]+)/)) t3 = t3.substr(RegExp.$1.length)
          ...
          ;((e3[e3.length] = { type: d, text: `${parseFloat(RegExp.$1)}` }),
            (t3 = t3.substr(RegExp.$1.length)))
        }
  ...
  for (const { key: h2, data: r2 } of t2)
    switch (h2) {
      ...
      case 'a':
        ;((e2 += r2[5]),
          (s2 += r2[6]),
          a2.push({ key: 'A', data: [r2[0], r2[1], r2[2], r2[3], r2[4], e2, s2] }))
        break
      case 'H':
    ...
    switch (c2) {
      ...
      case 'S': {
        let t3 = 0,
          a3 = 0
        ;('C' === s2 || 'S' === s2
          ? ((t3 = n2 + (n2 - r2)), (a3 = o2 + (o2 - i2)))
          : ((t3 = n2), (a3 = o2)),
          e2.push({ key: 'C', data: [t3, a3, ...l2] }),
          (r2 = l2[0]),
          (i2 = l2[1]),
          (n2 = l2[2]),
          (o2 = l2[3]))
      ...
      case 'T': {
        ...
        let h3 = 0,
          c3 = 0
        'Q' === s2 || 'T' === s2
          ? ((h3 = n2 + (n2 - r2)), (c3 = o2 + (o2 - i2)))
          : ((h3 = n2), (c3 = o2))
        const u2 = n2 + (2 * (h3 - n2)) / 3,
          p2 = o2 + (2 * (c3 - o2)) / 3,
          f2 = t3 + (2 * (h3 - t3)) / 3,
          d2 = a3 + (2 * (c3 - a3)) / 3
        ;(e2.push({ key: 'C', data: [u2, p2, f2, d2, t3, a3] }),
          (r2 = h3),
          (i2 = c3),
          (n2 = t3),
          (o2 = a3))
      ...
      case 'Q': {
        const [t3, s3, a3, h3] = l2,
          c3 = n2 + (2 * (t3 - n2)) / 3,
          u2 = o2 + (2 * (s3 - o2)) / 3,
          p2 = a3 + (2 * (t3 - a3)) / 3,
          f2 = h3 + (2 * (s3 - h3)) / 3
        ;(e2.push({ key: 'C', data: [c3, u2, p2, f2, a3, h3] }),
          (r2 = t3),
          (i2 = s3),
          (n2 = a3),
          (o2 = h3))
...
function x(t2, e2, s2, n2, o2, a2, h2, r2, i2, c2) {
  ...
  if (c2) [f2, d2, g2, M2] = c2
    ...
    const p3 = o2 * o2,
      k3 = a2 * a2,
      b3 = p3 * k3 - p3 * c3 * c3 - k3 * h3 * h3,
      y3 = p3 * c3 * c3 + k3 * h3 * h3,
      m3 = (r2 === i2 ? -1 : 1) * Math.sqrt(Math.abs(b3 / y3))
    ;((g2 = (m3 * o2 * c3) / a2 + (t2 + s2) / 2),
      (M2 = (m3 * -a2 * h3) / o2 + (e2 + n2) / 2),
      (f2 = Math.asin(parseFloat(((e2 - M2) / a2).toFixed(9)))),
      (d2 = Math.asin(parseFloat(((n2 - M2) / a2).toFixed(9)))),
      t2 < g2 && (f2 = Math.PI - f2),
      s2 < g2 && (d2 = Math.PI - d2),
      f2 < 0 && (f2 = 2 * Math.PI + f2),
      d2 < 0 && (d2 = 2 * Math.PI + d2),
      i2 && f2 > d2 && (f2 -= 2 * Math.PI),
      !i2 && d2 > f2 && (d2 -= 2 * Math.PI))
  }
  let k2 = d2 - f2
  if (Math.abs(k2) > (120 * Math.PI) / 180) {
    const t3 = d2,
      e3 = s2,
      r3 = n2
    ;((d2 = i2 && d2 > f2 ? f2 + ((120 * Math.PI) / 180) * 1 : f2 + ((120 * Math.PI) / 180) * -1),
      (p2 = x(
        (s2 = g2 + o2 * Math.cos(d2)),
        (n2 = M2 + a2 * Math.sin(d2)),
        e3,
        r3,
        o2,
        a2,
  ...
  const b2 = Math.cos(f2),
    ...
    O2 = (4 / 3) * a2 * v2,
    L2 = [t2, e2],
    T2 = [t2 + S2 * y2, e2 - O2 * b2],
    D2 = [s2 + S2 * P2, n2 - O2 * m2],
    A2 = [s2, n2]
  if (((T2[0] = 2 * L2[0] - T2[0]), (T2[1] = 2 * L2[1] - T2[1]), c2)) return [T2, D2, A2].concat(p2)
  {
    ...
    for (let e3 = 0; e3 < p2.length; e3 += 3) {
      const s3 = w(p2[e3][0], p2[e3][1], l2),
        n3 = w(p2[e3 + 1][0], p2[e3 + 1][1], l2),
        o3 = w(p2[e3 + 2][0], p2[e3 + 2][1], l2)
...
function S(t2, e2, s2) {
  ...
  if (n2 > 2) {
    ...
    return (
      e2 && o2.push(...$(t2[n2 - 1][0], t2[n2 - 1][1], t2[0][0], t2[0][1], s2)),
      { type: 'path', ops: o2 }
    )
  }
...
function L(t2, e2) {
  if (t2.length) {
    const s2 = 'number' == typeof t2[0][0] ? [t2] : t2,
      n2 = j(s2[0], 1 * (1 + 0.2 * e2.roughness), e2),
      o2 = e2.disableMultiStroke ? [] : j(s2[0], 1.5 * (1 + 0.22 * e2.roughness), z(e2))
    for (let t3 = 1; t3 < s2.length; t3++) {
      const a2 = s2[t3]
      if (a2.length) {
        const t4 = j(a2, 1 * (1 + 0.2 * e2.roughness), e2),
          s3 = e2.disableMultiStroke ? [] : j(a2, 1.5 * (1 + 0.22 * e2.roughness), z(e2))
...
function T(t2, e2, s2) {
  const n2 = Math.sqrt(2 * Math.PI * Math.sqrt((Math.pow(t2 / 2, 2) + Math.pow(e2 / 2, 2)) / 2)),
    o2 = Math.ceil(Math.max(s2.curveStepCount, (s2.curveStepCount / Math.sqrt(200)) * n2)),
    a2 = (2 * Math.PI) / o2
  let h2 = Math.abs(t2 / 2),
    r2 = Math.abs(e2 / 2)
...
function D(t2, e2, s2, n2) {
  const [o2, a2] = F(
    ...
    n2.ry,
    1,
    n2.increment * E(0.1, E(0.4, 1, s2), s2),
    s2
  )
  let h2 = q(o2, null, s2)
  if (!s2.disableMultiStroke && 0 !== s2.roughness) {
    const [o3] = F(n2.increment, t2, e2, n2.rx, n2.ry, 1.5, 0, s2),
      a3 = q(o3, null, s2)
    h2 = h2.concat(a3)
  }
...
function A(t2, e2, s2, n2, o2, a2, h2, r2, i2) {
  ...
  const g2 = (2 * Math.PI) / i2.curveStepCount,
    M2 = Math.min(g2 / 2, (d2 - f2) / 2),
    k2 = V(M2, c2, l2, u2, p2, f2, d2, 1, i2)
  ...
  return (
    h2 &&
      (r2
        ? k2.push(
            ...$(c2, l2, c2 + u2 * Math.cos(f2), l2 + p2 * Math.sin(f2), i2),
            ...$(c2, l2, c2 + u2 * Math.cos(d2), l2 + p2 * Math.sin(d2), i2)
          )
        : k2.push(
            { op: 'lineTo', data: [c2, l2] },
            { op: 'lineTo', data: [c2 + u2 * Math.cos(f2), l2 + p2 * Math.sin(f2)] }
          )),
    { type: 'path', ops: k2 }
  )
}
...
function I(t2, e2) {
  ...
  for (const n2 of t2)
    if (n2.length) {
      const t3 = e2.maxRandomnessOffset || 0,
        o2 = n2.length
      if (o2 > 2) {
...
function $(t2, e2, s2, n2, o2, a2 = false) {
  const h2 = a2 ? o2.disableMultiStrokeFill : o2.disableMultiStroke,
    r2 = R(t2, e2, s2, n2, o2, true, false)
  if (h2) return r2
  const i2 = R(t2, e2, s2, n2, o2, true, true)
  return r2.concat(i2)
}
function R(t2, e2, s2, n2, o2, a2, h2) {
  const r2 = Math.pow(t2 - s2, 2) + Math.pow(e2 - n2, 2),
    i2 = Math.sqrt(r2)
  let c2 = 1
  ...
  const u2 = l2 / 2,
    p2 = 0.2 + 0.2 * W(o2)
  let f2 = (o2.bowing * o2.maxRandomnessOffset * (n2 - e2)) / 200,
    d2 = (o2.bowing * o2.maxRandomnessOffset * (t2 - s2)) / 200
  ;((f2 = G(f2, o2, c2)), (d2 = G(d2, o2, c2)))
  const g2 = [],
    M2 = () => G(u2, o2, c2),
    k2 = () => G(l2, o2, c2),
    b2 = o2.preserveVertices
  return (
    a2 &&
      (h2
        ? g2.push({ op: 'move', data: [t2 + (b2 ? 0 : M2()), e2 + (b2 ? 0 : M2())] })
        : g2.push({
            op: 'move',
...
function j(t2, e2, s2) {
  if (!t2.length) return []
  const n2 = []
  ;(n2.push([t2[0][0] + G(e2, s2), t2[0][1] + G(e2, s2)]),
    n2.push([t2[0][0] + G(e2, s2), t2[0][1] + G(e2, s2)]))
  for (let o2 = 1; o2 < t2.length; o2++)
    (n2.push([t2[o2][0] + G(e2, s2), t2[o2][1] + G(e2, s2)]),
      o2 === t2.length - 1 && n2.push([t2[o2][0] + G(e2, s2), t2[o2][1] + G(e2, s2)]))
  return q(n2, null, s2)
}
function q(t2, e2, s2) {
  const n2 = t2.length,
  ...
  if (n2 > 3) {
    const a2 = [],
      h2 = 1 - s2.curveTightness
    o2.push({ op: 'move', data: [t2[1][0], t2[1][1]] })
    for (let e3 = 1; e3 + 2 < n2; e3++) {
      const s3 = t2[e3]
      ;((a2[0] = [s3[0], s3[1]]),
        (a2[1] = [
          s3[0] + (h2 * t2[e3 + 1][0] - h2 * t2[e3 - 1][0]) / 6,
          s3[1] + (h2 * t2[e3 + 1][1] - h2 * t2[e3 - 1][1]) / 6,
        ]),
        (a2[2] = [
          t2[e3 + 1][0] + (h2 * t2[e3][0] - h2 * t2[e3 + 2][0]) / 6,
          t2[e3 + 1][1] + (h2 * t2[e3][1] - h2 * t2[e3 + 2][1]) / 6,
        ]),
        (a2[3] = [t2[e3 + 1][0], t2[e3 + 1][1]]),
        o2.push({
          op: 'bcurveTo',
...
function F(t2, e2, s2, n2, o2, a2, h2, r2) {
  ...
  if (0 === r2.roughness) {
    ...
    ;(c2.push([e2 + n2 * Math.cos(0), s2 + o2 * Math.sin(0)]),
      c2.push([e2 + n2 * Math.cos(t2), s2 + o2 * Math.sin(t2)]))
  } else {
    const l2 = G(0.5, r2) - Math.PI / 2
    c2.push([
      G(a2, r2) + e2 + 0.9 * n2 * Math.cos(l2 - t2),
      G(a2, r2) + s2 + 0.9 * o2 * Math.sin(l2 - t2),
    ])
    ...
    ;(c2.push([
      G(a2, r2) + e2 + n2 * Math.cos(l2 + 2 * Math.PI + 0.5 * h2),
      G(a2, r2) + s2 + o2 * Math.sin(l2 + 2 * Math.PI + 0.5 * h2),
    ]),
      c2.push([
        G(a2, r2) + e2 + 0.98 * n2 * Math.cos(l2 + h2),
        G(a2, r2) + s2 + 0.98 * o2 * Math.sin(l2 + h2),
      ]),
      c2.push([
        G(a2, r2) + e2 + 0.9 * n2 * Math.cos(l2 + 0.5 * h2),
        G(a2, r2) + s2 + 0.9 * o2 * Math.sin(l2 + 0.5 * h2),
      ]))
  }
  return [c2, i2]
}
function V(t2, e2, s2, n2, o2, a2, h2, r2, i2) {
  const c2 = a2 + G(0.1, i2),
    l2 = []
  l2.push([
    G(r2, i2) + e2 + 0.9 * n2 * Math.cos(c2 - t2),
    G(r2, i2) + s2 + 0.9 * o2 * Math.sin(c2 - t2),
  ])
  for (let a3 = c2; a3 <= h2; a3 += t2)
    l2.push([G(r2, i2) + e2 + n2 * Math.cos(a3), G(r2, i2) + s2 + o2 * Math.sin(a3)])
  return (
    l2.push([e2 + n2 * Math.cos(h2), s2 + o2 * Math.sin(h2)]),
    l2.push([e2 + n2 * Math.cos(h2), s2 + o2 * Math.sin(h2)]),
    q(l2, null, i2)
  )
}
function Z(t2, e2, s2, n2, o2, a2, h2, r2) {
  const i2 = [],
    c2 = [r2.maxRandomnessOffset || 1, (r2.maxRandomnessOffset || 1) + 0.3]
  let l2 = [0, 0]
  const u2 = r2.disableMultiStroke ? 1 : 2,
    p2 = r2.preserveVertices
  for (let f2 = 0; f2 < u2; f2++)
    (0 === f2
      ? i2.push({ op: 'move', data: [h2[0], h2[1]] })
      : i2.push({
          op: 'move',
          data: [h2[0] + (p2 ? 0 : G(c2[0], r2)), h2[1] + (p2 ? 0 : G(c2[0], r2))],
        }),
      (l2 = p2 ? [o2, a2] : [o2 + G(c2[f2], r2), a2 + G(c2[f2], r2)]),
      i2.push({
        op: 'bcurveTo',
        data: [
          t2 + G(c2[f2], r2),
...
function H(t2, e2 = 0) {
  ...
  if (3 === s2) n2.push(Q(t2[0]), Q(t2[1]), Q(t2[2]), Q(t2[2]))
    ...
    for (let t3 = 1; t3 + 2 < s3.length; t3++) {
      ...
      ;((o2[0] = [e3[0], e3[1]]),
        (o2[1] = [
          e3[0] + (a2 * s3[t3 + 1][0] - a2 * s3[t3 - 1][0]) / 6,
          e3[1] + (a2 * s3[t3 + 1][1] - a2 * s3[t3 - 1][1]) / 6,
        ]),
        (o2[2] = [
          s3[t3 + 1][0] + (a2 * s3[t3][0] - a2 * s3[t3 + 2][0]) / 6,
          s3[t3 + 1][1] + (a2 * s3[t3][1] - a2 * s3[t3 + 2][1]) / 6,
        ]),
        (o2[3] = [s3[t3 + 1][0], s3[t3 + 1][1]]),
        n2.push(o2[1], o2[2], o2[3]))
    }
  }
  return n2
}
...
function X(t2, e2, s2, n2, o2) {
  ...
  return (
    Math.sqrt(i2) > n2
      ? (X(t2, e2, c2 + 1, n2, a2), X(t2, c2, s2, n2, a2))
      : (a2.length || a2.push(h2), a2.push(r2)),
    a2
  )
}
...
var et = class {
  ...
  arc(t2, e2, s2, n2, o2, a2, h2 = false, r2) {
    const i2 = this._o(r2),
      c2 = [],
      l2 = A(t2, e2, s2, n2, o2, a2, h2, true, i2)
    if (h2 && i2.fill)
      if ('solid' === i2.fillStyle) {
        ...
        c2.push(
          (function (t3, e3, s3, n3, o3, a3, h3) {
            const r3 = t3,
              i3 = e3
            let c3 = Math.abs(s3 / 2),
              l3 = Math.abs(n3 / 2)
            ...
            const f2 = (p2 - u2) / h3.curveStepCount,
              d2 = []
            for (let t4 = u2; t4 <= p2; t4 += f2)
              d2.push([r3 + c3 * Math.cos(t4), i3 + l3 * Math.sin(t4)])
            return (
              d2.push([r3 + c3 * Math.cos(p2), i3 + l3 * Math.sin(p2)]),
              d2.push([r3, i3]),
              C([d2], h3)
            )
        ...
        if (o3.length) {
          ...
          for (const n3 of t3)
            n3.length < 3
              ? e3.push(...n3)
              : 3 === n3.length
                ? e3.push(...Y(H([n3[0], n3[0], n3[1], n3[2]]), 10, (1 + s2.roughness) / 2))
                : e3.push(...Y(H(n3), 10, (1 + s2.roughness) / 2))
        }
  ...
  polygon(t2, e2) {
    const s2 = this._o(e2),
      ...
      o2 = S(t2, true, s2)
    return (
      s2.fill && ('solid' === s2.fillStyle ? n2.push(I([t2], s2)) : n2.push(C([t2], s2))),
      s2.stroke !== tt && n2.push(o2),
      this._d('polygon', n2, s2)
    )
  }
  path(t2, e2) {
    const s2 = this._o(e2),
    ...
    const o2 = s2.fill && 'transparent' !== s2.fill && s2.fill !== tt,
      a2 = s2.stroke !== tt,
      h2 = !!(s2.simplification && s2.simplification < 1),
      r2 = (function (t3, e3, s3) {
        const n3 = m(y(b(t3))),
          o3 = []
        let a3 = [],
          h3 = [0, 0],
        ...
        return l2
      })(t2, 1, h2 ? 4 - 4 * (s2.simplification || 1) : (1 + s2.roughness) / 2),
      i2 = _(t2, s2)
    if (o2)
      if ('solid' === s2.fillStyle)
        if (1 === r2.length) {
  ...
  toPaths(t2) {
    const e2 = t2.sets || [],
      s2 = t2.options || this.defaultOptions,
      n2 = []
    for (const t3 of e2) {
      let e3 = null
      switch (t3.type) {
  ...
  fillSketch(t2, e2) {
    ...
    return (
      s2 < 0 && (s2 = e2.strokeWidth / 2),
      { d: this.opsToPath(t2), stroke: e2.fill || tt, strokeWidth: s2, fill: tt }
    )
  }
  _mergedShape(t2) {
...
var st = class {
  ...
  draw(t2) {
    const e2 = t2.sets || [],
      s2 = t2.options || this.getDefaultOptions(),
      n2 = this.ctx,
      o2 = t2.options.fixedDecimalPlaceDigits
    for (const a2 of e2)
      switch (a2.type) {
        case 'path':
          ;(n2.save(),
            (n2.strokeStyle = 'none' === s2.stroke ? 'transparent' : s2.stroke),
            (n2.lineWidth = s2.strokeWidth),
            s2.strokeLineDash && n2.setLineDash(s2.strokeLineDash),
            s2.strokeLineDashOffset && (n2.lineDashOffset = s2.strokeLineDashOffset),
            this._drawToContext(n2, a2, o2),
            n2.restore())
          break
        case 'fillPath': {
          ;(n2.save(), (n2.fillStyle = s2.fill || ''))
          const e3 =
            'curve' === t2.shape || 'polygon' === t2.shape || 'path' === t2.shape
              ? 'evenodd'
              : 'nonzero'
  ...
  fillSketch(t2, e2, s2) {
    ...
    ;(n2 < 0 && (n2 = s2.strokeWidth / 2),
      t2.save(),
      s2.fillLineDash && t2.setLineDash(s2.fillLineDash),
      s2.fillLineDashOffset && (t2.lineDashOffset = s2.fillLineDashOffset),
      (t2.strokeStyle = s2.fill || ''),
      (t2.lineWidth = n2),
      this._drawToContext(t2, e2, s2.fixedDecimalPlaceDigits),
      t2.restore())
  }
...
var ot = class {
  ...
  draw(t2) {
    const e2 = t2.sets || [],
      s2 = t2.options || this.getDefaultOptions(),
      n2 = this.svg.ownerDocument || window.document,
      o2 = n2.createElementNS(nt, 'g'),
      a2 = t2.options.fixedDecimalPlaceDigits
    for (const h2 of e2) {
      let e3 = null
      switch (h2.type) {
        case 'path':
          ;((e3 = n2.createElementNS(nt, 'path')),
            e3.setAttribute('d', this.opsToPath(h2, a2)),
            e3.setAttribute('stroke', s2.stroke),
            e3.setAttribute('stroke-width', s2.strokeWidth + ''),
            e3.setAttribute('fill', 'none'),
            s2.strokeLineDash &&
              e3.setAttribute('stroke-dasharray', s2.strokeLineDash.join(' ').trim()),
            s2.strokeLineDashOffset &&
              e3.setAttribute('stroke-dashoffset', `${s2.strokeLineDashOffset}`))
          break
        case 'fillPath':
          ;((e3 = n2.createElementNS(nt, 'path')),
            e3.setAttribute('d', this.opsToPath(h2, a2)),
            e3.setAttribute('stroke', 'none'),
            e3.setAttribute('stroke-width', '0'),
            e3.setAttribute('fill', s2.fill || ''),
            ('curve' !== t2.shape && 'polygon' !== t2.shape) ||
              e3.setAttribute('fill-rule', 'evenodd'))
          break
        case 'fillSketch':
  ...
  fillSketch(t2, e2, s2) {
    ...
    return (
      o2.setAttribute('d', this.opsToPath(e2, s2.fixedDecimalPlaceDigits)),
      o2.setAttribute('stroke', s2.fill || ''),
      o2.setAttribute('stroke-width', n2 + ''),
      o2.setAttribute('fill', 'none'),
      s2.fillLineDash && o2.setAttribute('stroke-dasharray', s2.fillLineDash.join(' ').trim()),
      s2.fillLineDashOffset && o2.setAttribute('stroke-dashoffset', `${s2.fillLineDashOffset}`),
      o2
    )
  }
  get generator() {
...
export { at }
//# sourceMappingURL=chunk-5G2FUE7H.js.map
